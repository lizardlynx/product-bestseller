module.exports = {
  ...
  getProductsByCategory: `query ($searchQuery: String!, $currentPage: Int!, $pageSize: Int!, $priceSet: Boolean!, $category: [Int], $max_price: Float, $min_price: Float, $sort: sortAttribute, $filter: [filterAttribute]) {
