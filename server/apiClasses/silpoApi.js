...
class SilpoApi extends BaseApi {
  ...
  async loadProductsByCategory(id) {
    ...
    console.log(
      id,
      this.#getProductByCategoryItemsCount,
      this.#getProductByCategoryVariables.data.From,
      this.#getProductByCategoryVariables.data.To
    );
    const res = await this.#processSilpoRequest(
      this.#silpoApiLink,
