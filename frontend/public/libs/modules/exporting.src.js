...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/exporting", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
  ...
  _registerModule(
    _modules,
    "Extensions/Exporting/ExportingSymbols.js",
    [],
    function () {
      /* *
       *
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Extensions/Exporting/ExportingDefaults.js"],
      _modules["Extensions/Exporting/ExportingSymbols.js"],
      _modules["Extensions/Exporting/Fullscreen.js"],
      _modules["Core/Globals.js"],
      _modules["Core/HttpUtilities.js"],
      ...
      (function (Exporting) {
        ...
        function addButton(options) {
          ...
          const button = renderer
            ...
            .attr({
              title: pick(
                chart.options.lang[btnOptions._titleKey || btnOptions.titleKey],
                ""
              ),
            });
          button.menuClassName =
            options.menuClassName || "highcharts-menu-" + chart.btnCount++;
          ...
          button.add(chart.exportingGroup).align(
            extend(btnOptions, {
              width: button.width,
        ...
        function beforePrint() {
          ...
          const handleMaxWidth =
            printMaxWidth && chart.chartWidth > printMaxWidth;
          if (handleMaxWidth) {
            ...
            items.forEach(function (item) {
              ...
              if (isObject(item, true)) {
                ...
                if (item.separator) {
                  ...
                  AST.setElementHTML(
                    element,
                    item.text || chart.options.lang[item.textKey]
                  );
                  if (!chart.styledMode) {
        ...
        function getSVG(chartOptions) {
          ...
          chart.axes.forEach(function (axis) {
            ...
            if (
              axisCopy &&
              ((typeof userMin !== "undefined" && userMin !== axisCopy.min) ||
                (typeof userMax !== "undefined" && userMax !== axisCopy.max))
            ) {
        ...
        function inlineStyles() {
          ...
          function recurse(node) {
            ...
            function filterStyles(val, prop) {
              ...
              while (i-- && !denylisted) {
                denylisted =
                  denylist[i].test(prop) || typeof val === "function";
              }
              if (!denylisted) {
        ...
        function onChartInit() {
          ...
          ChartNavigationComposition.compose(chart).navigation.addUpdate(
            (options, redraw) => {
  ...
  _registerModule(
    ...
    [
      _modules["Core/Globals.js"],
      _modules["Extensions/Exporting/Exporting.js"],
      _modules["Core/HttpUtilities.js"],
    ],
    function (Highcharts, Exporting, HttpUtilities) {
      const G = Highcharts;
