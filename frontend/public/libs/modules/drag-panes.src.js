...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/drag-panes", [
      "highcharts",
  ...
  _registerModule(
    _modules,
    "Extensions/DragPanes/AxisResizerDefaults.js",
    [],
    function () {
      /* *
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/DragPanes/AxisResizerDefaults.js"],
      _modules["Core/Globals.js"],
      _modules["Core/Utilities.js"],
    ],
    function (AxisResizerDefaults, H, U) {
      /* *
       *
       *  Plugin for resizing axes / panes in a chart.
       *
        ...
        onMouseMove(e) {
          ...
          if (!e.touches || e.touches[0].pageX !== 0) {
            ...
            if (this.grabbed) {
              ...
              this.updateAxes(
                this.axis.chart.pointer.normalize(e).chartY - this.options.y
              );
            }
          }
        }
        ...
        updateAxes(chartY) {
          ...
          [prevAxes, nextAxes].forEach((axesGroup, isNext) => {
            axesGroup.forEach((axisInfo, i) => {
              ...
              top = axis.top;
              const minLength = Math.round(
                  relativeLength(axisOptions.minLength, plotHeight)
                ),
                maxLength = Math.round(
                  relativeLength(axisOptions.maxLength, plotHeight)
                );
              if (isNext) {
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/DragPanes/AxisResizer.js"],
      _modules["Core/Utilities.js"],
    ],
    function (AxisResizer, U) {
      /* *
       *
       *  Plugin for resizing axes / panes in a chart.
       *
  ...
  _registerModule(
    ...
    [
      _modules["Core/Globals.js"],
      _modules["Extensions/DragPanes/AxisResizer.js"],
      _modules["Extensions/DragPanes/DragPanes.js"],
    ],
    function (Highcharts, AxisResizer, DragPanes) {
      const G = Highcharts;
