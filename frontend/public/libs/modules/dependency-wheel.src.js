...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/dependency-wheel", [
      "highcharts",
        ...
        getDataLabelPath(label) {
          ...
          this.dataLabelPath = renderer
            .arc({
              open: true,
              longArc:
                Math.abs(Math.abs(start) - Math.abs(end)) < Math.PI ? 0 : 1,
            })
            .attr({
              x: shapeArgs.x,
              y: shapeArgs.y,
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Series/DependencyWheel/DependencyWheelPoint.js"],
      _modules["Series/DependencyWheel/DependencyWheelSeriesDefaults.js"],
    ...
    function (
      ...
      class DependencyWheelSeries extends SankeySeries {
        ...
        translate() {
          const options = this.options,
            ...
            borderRadius =
              typeof brOption === "object" ? brOption.radius : brOption;
      ...
      DependencyWheelSeries.defaultOptions = merge(
  ...
  _registerModule(
    _modules,
    "masters/modules/dependency-wheel.src.js",
    [],
    function () {}
  );
});
