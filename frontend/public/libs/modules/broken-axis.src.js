...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/broken-axis", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
  ...
  _registerModule(
    ...
    [
      _modules["Core/Axis/Stacking/StackItem.js"],
      _modules["Core/Utilities.js"],
    ],
    function (StackItem, U) {
      /* *
       *
       *  (c) 2009-2021 Torstein Honsi
       *
  ...
  _registerModule(
    ...
    [_modules["Core/Globals.js"], _modules["Core/Axis/BrokenAxis.js"]],
    function (Highcharts, BrokenAxis) {
      const G = Highcharts;
      // Compositions
