...
(function (factory) {
  ...
  _registerModule(
    _modules,
    "Extensions/Debugger/ErrorMessages.js",
    [],
    function () {
      /* eslint-disable */
      /* *
  ...
  _registerModule(
    ...
    function (ErrorMessages, H, D, U) {
      ...
      function onHighchartsDisplayError(e) {
        ...
        const chart =
          e.chart || find(this.charts.slice().reverse(), (c) => !!c);
        if (!chart) {
          return;
        }
        const code = e.code,
  ...
  _registerModule(
    ...
    [
      _modules["Core/Globals.js"],
      _modules["Extensions/Debugger/Debugger.js"],
      _modules["Extensions/Debugger/ErrorMessages.js"],
    ],
    function (Highcharts, Debugger, ErrorMessages) {
      const G = Highcharts;
