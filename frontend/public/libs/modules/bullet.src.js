...
(function (factory) {
  ...
  _registerModule(
    ...
    [
      _modules["Series/Bullet/BulletPoint.js"],
      _modules["Core/Series/SeriesRegistry.js"],
      _modules["Core/Utilities.js"],
    ],
    function (BulletPoint, SeriesRegistry, U) {
      /* *
       *
       *  (c) 2010-2021 Kacper Madej
       *
        ...
        drawPoints() {
          ...
          series.points.forEach(function (point) {
            ...
            if (isNumber(targetVal) && targetVal !== null) {
              ...
              y =
                series.yAxis.translate(targetVal, false, true, false, true) -
                targetOptions.height / 2 -
                0.5;
