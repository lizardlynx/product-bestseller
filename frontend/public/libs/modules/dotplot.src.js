...
(function (factory) {
  ...
  _registerModule(
    ...
    function (ColumnSeries, SeriesRegistry, U) {
      /* *
       *
        ...
        drawPoints() {
          const series = this,
            ...
            itemPaddingTranslated =
              this.yAxis.transA * series.options.itemPadding,
          ...
          this.points.forEach(function (point) {
            ...
            if (point.y !== null) {
              ...
              for (yPos = yTop; yPos > yTop - point.y; yPos--, i--) {
                x =
                  point.barX + (isSquare ? point.pointWidth / 2 - size / 2 : 0);
                y =
                  series.yAxis.toPixels(yPos, true) + itemPaddingTranslated / 2;
  ...
  _registerModule(
    _modules,
    "masters/modules/dotplot.src.js",
    [],
    function () {}
  );
});
