...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/cylinder", [
      "highcharts",
  ...
  _registerModule(
    ...
    function (Color, H, Math3D, RendererRegistry, U) {
      /* *
       *
       *  Highcharts cylinder - a 3D series
       *
      ...
      rendererProto.getCylinderEnd = function (chart, shapeArgs, isBottom) {
        ...
        let depth = pick(shapeArgs.depth, width, 0),
          ...
          angleOffset =
            deg2rad *
            (chart.options.chart.options3d.beta - 90 + alphaCorrection),
  ...
  _registerModule(
    ...
    [
      _modules["Series/Cylinder/CylinderPoint.js"],
      _modules["Core/Series/SeriesRegistry.js"],
      _modules["Core/Utilities.js"],
    ],
    function (CylinderPoint, SeriesRegistry, U) {
      /* *
       *
       *  Highcharts cylinder - a 3D series
       *
  ...
  _registerModule(
    _modules,
    "masters/modules/cylinder.src.js",
    [],
    function () {}
  );
});
