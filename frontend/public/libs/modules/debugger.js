...
(function (a) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/modules/debugger", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a;
      })
  ...
  a = a ? a._modules : {};
  b(a, "Extensions/Debugger/ErrorMessages.js", [], function () {
    return {
      10: {
  ...
  b(
    a,
    "Extensions/Debugger/Debugger.js",
    [
      a["Extensions/Debugger/ErrorMessages.js"],
      a["Core/Globals.js"],
      a["Core/Defaults.js"],
      a["Core/Utilities.js"],
    ],
    function (a, c, b, e) {
      function l() {
        const a = this.errorElements;
        if (a && a.length) for (const d of a) d.destroy();
        delete this.errorElements;
      }
      function m(b) {
        const d = b.chart || n(this.charts.slice().reverse(), (a) => !!a);
        if (d) {
          var c = b.code,
            e = d.options.chart;
          b = d.renderer;
          if (d.errorElements) for (f of d.errorElements) f && f.destroy();
          if (e && e.displayErrors && b) {
            d.errorElements = [];
            var f = p(c) ? "Highcharts error #" + c + ": " + a[c].text : c;
            c = d.chartWidth;
            e = d.chartHeight;
            f = f
              .replace(
            ...
            d.errorElements[0] = b
              .rect(2, 2, c - 4, e - 4)
              .attr({ "stroke-width": 4, stroke: "#ff0000", zIndex: 3 })
              .add();
            d.errorElements[1] = b
              .label(
                f,
              ...
              .add();
            d.errorElements[1].attr({
              y: e - d.errorElements[1].getBBox().height,
            });
          }
        }
      }
      const { setOptions: h } = b,
        { addEvent: k, find: n, isNumber: p } = e,
        g = [],
        q = { chart: { displayErrors: !0 } };
      return {
        compose: function (a) {
          e.pushUnique(g, a) && k(a, "beforeRedraw", l);
          e.pushUnique(g, c) && k(c, "displayError", m);
          e.pushUnique(g, h) && h(q);
        },
      };
    }
  );
  b(
    ...
    [
      a["Core/Globals.js"],
      a["Extensions/Debugger/Debugger.js"],
      a["Extensions/Debugger/ErrorMessages.js"],
    ],
    function (a, c, b) {
      a.errorMessages = b;
