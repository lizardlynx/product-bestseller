...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/datagrouping", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/DataGrouping/ApproximationRegistry.js"],
      _modules["Core/Utilities.js"],
    ],
    function (ApproximationRegistry, U) {
      /* *
       *
       *  (c) 2010-2021 Torstein Honsi
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/DataGrouping/DataGroupingDefaults.js"],
      _modules["Core/Utilities.js"],
    ],
    function (DataGroupingDefaults, U) {
      /* *
       *
       *  (c) 2010-2021 Torstein Honsi
       *
      ...
      function applyGrouping(e) {
        ...
        series.forEach(function (series) {
          series.groupPixelWidth =
            axis.getGroupPixelWidth && axis.getGroupPixelWidth();
  ...
  _registerModule(
    ...
    function (
        ...
        if (
          ...
          if (
            ...
            const lastGroupStart =
              series.groupMap[series.groupMap.length - 1].start;
      ...
      function applyGrouping(hasExtremesChanged) {
        ...
        // (in that order).
        const skip =
          skipDataGrouping(series, hasExtremesChanged) === false ||
          !groupingEnabled;
      ...
      function onAfterSetOptions(e) {
        const options = e.options,
          ...
          baseOptions =
            this.useCommonDataGrouping && DataGroupingDefaults.common,
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/DataGrouping/DataGroupingAxisComposition.js"],
      _modules["Extensions/DataGrouping/DataGroupingDefaults.js"],
      _modules["Extensions/DataGrouping/DataGroupingSeriesComposition.js"],
      _modules["Core/FormatUtilities.js"],
      _modules["Core/Utilities.js"],
    ],
    function (
      DataGroupingAxisComposition,
      DataGroupingDefaults,
      DataGroupingSeriesComposition,
      F,
      U
    ) {
      /* *
      ...
      function compose(AxisClass, SeriesClass, TooltipClass) {
        ...
        if (TooltipClass && U.pushUnique(composedMembers, TooltipClass)) {
      ...
      function onTooltipHeaderFormatter(e) {
        ...
        let xDateFormat = tooltipOptions.xDateFormat,
          ...
          formattedKey,
          formatString =
            tooltipOptions[e.isFooter ? "footerFormat" : "headerFormat"];
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Extensions/DataGrouping/ApproximationDefaults.js"],
      _modules["Extensions/DataGrouping/ApproximationRegistry.js"],
      _modules["Extensions/DataGrouping/DataGrouping.js"],
    ],
    function (
      Highcharts,
