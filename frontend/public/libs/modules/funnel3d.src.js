...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/funnel3d", [
      "highcharts",
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Core/Renderer/SVG/SVGRenderer3D.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Color, H, SVGRenderer3D, U) {
      /* *
       *
  ...
  _registerModule(
    ...
    [
      _modules["Series/Funnel3D/Funnel3DComposition.js"],
      _modules["Series/Funnel3D/Funnel3DPoint.js"],
      _modules["Core/Globals.js"],
      _modules["Core/Math3D.js"],
      ...
      class Funnel3DSeries extends ColumnSeries {
        ...
        alignDataLabel(point, _dataLabel, options) {
          const series = this,
            ...
            below =
              point.plotY > pick(series.translatedThreshold, series.yAxis.len),
        ...
        translate() {
          ...
          series.getWidthAt = getWidthAt = function (y) {
            ...
            return y > neckY || height === neckHeight
              ? neckWidth
              : neckWidth +
                  (width - neckWidth) * (1 - (y - top) / (height - neckHeight));
          };
          // Expose
  ...
  _registerModule(
    ...
    [
      _modules["Core/Renderer/RendererRegistry.js"],
      _modules["Series/Funnel3D/Funnel3DSeries.js"],
    ],
    function (RendererRegistry, Funnel3DSeries) {
