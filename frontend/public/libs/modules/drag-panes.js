...
(function (a) {
  ...
  c(
    a,
    "Extensions/DragPanes/AxisResizer.js",
    [
      a["Extensions/DragPanes/AxisResizerDefaults.js"],
      a["Core/Globals.js"],
      a["Core/Utilities.js"],
    ],
    function (a, d, c) {
      ...
      class p {
        ...
        addMouseEvents() {
          ...
          c.push(
            e(d, "mousemove", m),
            e(d.ownerDocument, "mouseup", l),
            e(a, "mousedown", h)
          );
          n &&
            c.push(
              e(d, "touchmove", m),
              e(d.ownerDocument, "touchend", l),
              e(a, "touchstart", h)
            );
          b.eventsToUnbind = c;
        }
        onMouseMove(b) {
          (b.touches && 0 === b.touches[0].pageX) ||
            ...
            ((this.hasDragged = !0),
            this.updateAxes(
              this.axis.chart.pointer.normalize(b).chartY - this.options.y
            ));
        }
        onMouseUp(b) {
          this.hasDragged &&
        ...
        updateAxes(b) {
          ...
          const n =
            0 === c.next.length ? [d.yAxis.indexOf(a.axis) + 1] : c.next;
          ...
          1 > u * u ||
            ([c, n].forEach((c, f) => {
              c.forEach((c, k) => {
                var g =
                  (c = v(c) ? d.yAxis[c] : f || k ? d.get(c) : c) && c.options;
                if (g && "navigator-y-axis" !== g.id) {
                  ...
                  f
                    ? ((u = b - a.lastPos),
                      (g = Math.round(m(c.len - u, n, r))),
                      (k = c.top + u),
                      k + g > q && ((r = q - g - k), (b += r), (k += r)),
                      k < h && ((k = h), k + g > q && (g = e)),
                      g === n && (p = !0),
                      l.push({
                        axis: c,
                    ...
                    : ((g = Math.round(m(b - k, n, r))),
                      g === r && (p = !0),
                      (b = k + g),
                      l.push({
                        axis: c,
                        options: { height: (100 * g) / e + "%" },
                      }));
                }
              });
            }),
  ...
  c(
    a,
    "Extensions/DragPanes/DragPanes.js",
    [a["Extensions/DragPanes/AxisResizer.js"], a["Core/Utilities.js"]],
    function (a, c) {
      function d() {
        let b = this.resizer;
        ...
        c &&
          ...
          b
            ? c
              ? b.init(this, !0)
              : b.destroy()
            : c && (this.resizer = new a(this)));
      }
      function n(b) {
        !b.keepEvents && this.resizer && this.resizer.destroy();
      }
      function e(b) {
        this.chart.activeResizer ||
      ...
      const { addEvent: v, merge: x, wrap: t } = c,
        p = [];
      return {
        compose: function (b, f) {
          c.pushUnique(p, b) &&
            (x(!0, b.defaultOptions, a.resizerOptions),
            b.keepProps.push("resizer"),
            v(b, "afterRender", d),
            v(b, "destroy", n));
          c.pushUnique(p, f) &&
            (t(f.prototype, "runPointActions", m), t(f.prototype, "drag", e));
        },
      };
    }
  );
  c(
    a,
    "masters/modules/drag-panes.src.js",
    [
      a["Core/Globals.js"],
      a["Extensions/DragPanes/AxisResizer.js"],
      a["Extensions/DragPanes/DragPanes.js"],
    ],
    function (a, c, q) {
      a.AxisResizer = c;
