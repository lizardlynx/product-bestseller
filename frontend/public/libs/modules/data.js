...
$jscomp.polyfill = function (a, c, b, d) {
  c &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(a, c, b, d)
      : $jscomp.polyfillUnisolated(a, c, b, d));
};
...
(function (a) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/modules/data", ["highcharts"], function (c) {
        a(c);
        a.Highcharts = c;
        return a;
      })
      ...
      const { doc: b } = a,
        ...
        I = {
            ...
            b.onreadystatechange = function () {
              ...
              if (4 === b.readyState) {
                if (200 === b.status) {
                  if (
                    "blob" !== a.responseType &&
                    ((c = b.responseText), "json" === a.dataType)
                  )
                    try {
                      c = JSON.parse(c);
                    } catch (B) {
          ...
          post: function (a, c, h) {
            ...
            A(c, function (a, b) {
              d("input", { type: "hidden", name: b, value: a }, void 0, q);
            });
            q.submit();
            v(q);
          },
    ...
    function (a, c, h, q, v, E, A) {
      ...
      class D {
        ...
        static rowsToColumns(f) {
          let a, k, n, e, g;
          if (f)
            for (g = [], k = f.length, a = 0; a < k; a++)
              for (e = f[a].length, n = 0; n < e; n++)
                g[n] || (g[n] = []), (g[n][a] = f[a][n]);
          return g;
        }
        constructor(a, l = {}, k) {
        ...
        init(a, l, k) {
          ...
          this.rawColumns = [];
          this.columns.length && (this.dataFound(), (e = !b(a)));
        ...
        parseCSV(a) {
          function f(a, f, e, l) {
            ...
            function b() {
              z > w || w > p
                ...
                : (!isNaN(parseFloat(u)) && isFinite(u)
                    ? ((u = parseFloat(u)), c("number"))
                    : isNaN(Date.parse(u))
                    ? c("string")
                    : ((u = u.replace(/\//g, "-")), c("date")),
                  g.length < t + 1 && g.push([]),
                  e || (g[t][f] = u),
                  (u = ""),
                  ++t,
            ...
            if (a.trim().length && "#" !== a.trim()[0]) {
              for (; n < a.length; n++)
                ...
                else l && l[m] ? l[m](m, u) && b() : m === q ? b() : (u += m);
              b();
            }
          }
          function k(a) {
              ...
              for (d = 0; d < l.length; d++)
                !1 !== l[d]
                  ? 12 < k[d] &&
                    ...
                    "YYYY" !== g[d] &&
                    (g[d] = "YY")
                  : 12 < k[d] && "mm" === g[d] && (g[d] = "dd");
              3 === g.length && "dd" === g[1] && "dd" === g[2] && (g[2] = "YY");
              a = g.join("/");
              return (c.dateFormats || e.dateFormats)[a]
                ? a
                : (N("deduceDateFailed"), "YYYY/mm/dd");
            }
            return "YYYY/mm/dd";
          }
          const e = this,
          ...
          let h = c.endRow || Number.MAX_VALUE,
            q,
            t = 0;
          ...
          if (d) {
            ...
            if (!a || 0 > a) a = 0;
            if (!h || h >= d.length) h = d.length - 1;
            c.itemDelimiter ? (q = c.itemDelimiter) : ((q = null), (q = k(d)));
            let e = 0;
            for (t = a; t <= h; t++) "#" === d[t][0] ? e++ : f(d[t], t - a - e);
              ...
              f >= k &&
                ...
                [].forEach.call(a.children, (a, c) => {
                  ...
                  if (
                    ...
                    for (
                      l[c - e] || (l[c - e] = []),
                        l[c - e][f - k] = a.innerHTML;
                      f - k >= d && void 0 === b[f - k - d];
          ...
          function a(f) {
            function b(b, g, n) {
              function m() {
                e &&
                  k.liveDataURL === b &&
                  (l.liveDataTimeout = setTimeout(a, h));
              }
              if (!b || !/^(http|\/|\.\/|\.\.\/)/.test(b))
                return b && c.error && c.error("Invalid URL"), !1;
              f && (clearTimeout(l.liveDataTimeout), (k.liveDataURL = b));
              H({
                url: b,
                dataType: n || "json",
                success: function (a) {
            ...
            b(
              ...
              b(g.rowsURL, function (a) {
                k.update({ data: { rows: a } });
              }) ||
              b(g.columnsURL, function (a) {
                k.update({ data: { columns: a } });
              });
          }
          const l = this,
            k = this.chart,
        ...
        parseGoogleSpreadsheet() {
          function a(f) {
            ...
            H({
              ...
              success: function (e) {
                f(e);
                b.enablePolling &&
                  (c.liveDataTimeout = setTimeout(function () {
                    a(f);
                  }, g));
              },
              error: function (a, f) {
          ...
          const c = this,
            ...
            h = () => {
              if (b.googleSpreadsheetRange) return b.googleSpreadsheetRange;
              const a =
                ("ABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(b.startColumn || 0) ||
                  "A") +
                ((b.startRow || 0) + 1);
              let f =
                "ABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(G(b.endColumn, -1)) || "ZZ";
              C(b.endRow) && (f += b.endRow + 1);
              return `${a}:${f}`;
            };
          d &&
            (delete b.googleSpreadsheetKey,
            a(function (a) {
              a = a.values;
        ...
        parseColumn(a, b) {
          ...
          l =
            g &&
            ((l && l.xAxis && "category" === P(l.xAxis)[0].type) ||
              "string" === h);
          const r = C(a.name);
          let m = a.length;
          let q, v, x, t, w;
            ...
            l || (0 === m && e && !r)
              ...
              ? ((a[m] = q),
                31536e6 < q && "float" !== h
                  ? (a.isDatetime = !0)
                  : (a.isNumeric = !0),
                "undefined" !== typeof a[m + 1] && (w = q > a[m + 1]))
              : (v && v.length && (t = this.parseDate(y)),
                g && J(t) && "float" !== h
                  ? ((d[m] = y),
                    (a[m] = t),
                    (a.isDatetime = !0),
                    "undefined" !== typeof a[m + 1] &&
                      ((y = t > a[m + 1]),
                      y !== w &&
                        "undefined" !== typeof w &&
          ...
          if (g && w && this.options.sort)
            for (b = 0; b < f.length; b++)
              f[b].reverse(), e && f[b].unshift(f[b].pop());
        }
        parseDate(a) {
          ...
          if (b) c = b(a);
            ...
            d ||
              ...
              (d = Date.parse(a)),
              "object" === typeof d && null !== d && d.getTime
                ? (c = d.getTime() - 6e4 * d.getTimezoneOffset())
                : J(d) && (c = d - 6e4 * new Date(d).getTimezoneOffset()));
          }
          return c;
        }
        getData() {
        ...
        complete() {
          ...
          if (b.complete || b.afterComplete) {
            ...
            h = [];
            {
              ...
              var r = [];
              let b;
              for (g = 0; g < q; g += 1) e.push(!0);
              for (q = 0; q < p.length; q += 1)
                for (
                  b = p[q].getReferencedColumnIndexes(), g = 0;
                  g < b.length;
                  g += 1
                )
                  e[b[g]] = !1;
              for (g = 0; g < e.length; g += 1) e[g] && r.push(g);
            }
            ...
            for (; 0 < r.length; ) {
              ...
              for (e = 0; e < this.valueCount.global; e++)
                p.addColumnReader(
                  void 0,
                  this.valueCount.globalPointArrayMap[e]
                );
              p.populateColumns(r) && c.push(p);
            }
            0 < c.length &&
              0 < c[0].readers.length &&
              ((p = a[c[0].readers[0].columnIndex]),
              "undefined" !== typeof p &&
                (p.isDatetime
                  ? (d = "datetime")
                  : p.isNumeric || (d = "category")));
            if ("category" === d)
              for (e = 0; e < c.length; e++)
                for (p = c[e], r = 0; r < p.readers.length; r++)
                  "x" === p.readers[r].configName &&
                    (p.readers[r].configName = "name");
            for (e = 0; e < c.length; e++) {
              p = c[e];
              r = [];
              for (g = 0; g < a[0].length; g++) r[g] = p.read(a, g);
              h[e] = { data: r };
          ...
          a &&
            ((a.afterComplete = function (a) {
              a &&
                (a.xAxis &&
                  c.xAxis[0] &&
                  a.xAxis.type === c.xAxis[0].options.type &&
                  delete a.xAxis,
                c.update(a, b, !0));
            }),
            x(!0, d.data, a),
            d.data &&
              d.data.googleSpreadsheetKey &&
              !a.columns &&
              delete d.data.columns,
            this.init(d.data));
        }
      }
      B(a, "init", function (a) {
        ...
        read(a, b) {
          ...
          this.readers.forEach((e) => {
            ...
            c
              ...
              ? v.prototype.setNestedProperty(d, f, e.configName)
              : (d[e.configName] = f);
          });
          if ("undefined" === typeof this.name && 2 <= this.readers.length) {
            ...
            this.readers.forEach(function (a) {
              ("x" !== a.configName &&
                "name" !== a.configName &&
                "y" !== a.configName) ||
                "undefined" === typeof a.columnIndex ||
                b.push(a.columnIndex);
            });
            2 <= b.length &&
              (b.shift(),
              b.sort(function (a, b) {
  ...
  c(
    ...
    [a["Core/Globals.js"], a["Core/HttpUtilities.js"], a["Extensions/Data.js"]],
    function (a, c, h) {
      a.ajax = c.ajax;
      a.data = h.data;
      a.getJSON = c.getJSON;
