...
(function (d) {
  ...
  q(
    ...
    function (d) {
      function n(a, b) {
        ...
        v(b, !0) && (a.redraw(), a.graphic.attr({ opacity: 1 }));
        return a;
      }
      function k() {
        const a = this;
        a.plotBoxClip = this.renderer.clipRect(this.plotBox);
        a.controlPointsGroup = a.renderer
          .g("control-points")
          .attr({ zIndex: 99 })
          .clip(a.plotBoxClip)
          .add();
        ...
        b(a, "exportData", function (b) {
          const c = (
            ...
            h =
              a.options.lang &&
              a.options.lang.exportData &&
              a.options.lang.exportData.annotationHeader,
            e = function (a) {
              let b;
              if (c && ((b = c(a)), !1 !== b)) return b;
              b = h + " " + a;
              return l ? { columnTitle: b, topLevelColumnTitle: b } : b;
            },
            v = b.dataRows[0].length,
            f =
              a.options.exporting &&
              a.options.exporting.csv &&
              a.options.exporting.csv.annotations &&
              a.options.exporting.csv.annotations.itemDelimiter,
            m =
              a.options.exporting &&
              a.options.exporting.csv &&
              a.options.exporting.csv.annotations &&
              a.options.exporting.csv.annotations.join;
            ...
            a.options.labelOptions &&
              ...
              a.labels.forEach((a) => {
                if (a.options.text) {
                  ...
                  a.points.forEach((a) => {
                    const l = a.x,
                      h = a.series.xAxis ? a.series.xAxis.options.index : -1;
                    let e = !1;
                    if (-1 === h) {
          ...
          let p = 0;
          b.dataRows.forEach((a) => {
            p = Math.max(p, a.length);
          });
          const d = p - b.dataRows[0].length;
          for (let a = 0; a < d; a++) {
            const c = e(a + 1);
            l
              ? (b.dataRows[0].push(c.topLevelColumnTitle),
                b.dataRows[1].push(c.columnTitle))
              : b.dataRows[0].push(c);
          }
        });
      }
      ...
      function f(a) {
        ...
        c &&
          (h(c, "remove"),
          m(this.options.annotations, c.options),
          m(b, c),
          c.destroy());
      }
      function c() {
      ...
      (function (h) {
        h.compose = function (h, e, l) {
          d.pushUnique(A, e) &&
            ...
            (e.addAnnotation = n),
            e.callbacks.push(k),
            (e.collectionsWithInit.annotations = [n]),
            e.collectionsWithUpdate.push("annotations"),
            (e.drawAnnotations = g),
            (e.removeAnnotation = f),
            (e.initAnnotation = function (a) {
    ...
    function (d, n) {
      ...
      class e {
        addEvents() {
          ...
          a(b.options.events, (a, c) => {
            const e = function (e) {
              ("click" === c && b.cancelClick) ||
                a.call(b, b.chart.pointer.normalize(e), b.target);
            };
            if (-1 === (b.nonDOMEvents || []).indexOf(c)) b.graphic.on(c, e);
            else f(b, c, e, { passive: !1 });
          });
          if (
            b.options.draggable &&
            (f(b, "drag", b.onDrag), !b.graphic.renderer.styledMode)
          ) {
            const a = {
        ...
        onDrag(a) {
          if (
            ...
            this.points.length
              ...
              : (this.shapes.forEach((a) => a.translate(b.x, b.y)),
                this.labels.forEach((a) => a.translate(b.x, b.y)));
            this.redraw(!1);
          }
        }
        onMouseDown(a) {
  ...
  q(
    ...
    [d["Extensions/Annotations/EventEmitter.js"], d["Core/Utilities.js"]],
    function (d, n) {
      const { merge: k, pick: g } = n;
      class f extends d {
        constructor(c, a, b, f) {
          super();
          this.graphic = void 0;
        ...
        render() {
          const c = this.chart,
            a = this.options;
          this.graphic = c.renderer
            .symbol(a.symbol, 0, 0, a.width, a.height)
            .add(c.controlPointsGroup)
            .css(a.style);
      ...
      class c {
        ...
        static pointToPixels(a, b) {
          ...
          e.inverted &&
            (a.mock
              ? ((f = a.plotY), (d = a.plotX))
              : ((f = e.plotWidth - (a.plotY || 0)),
                (d = e.plotHeight - (a.plotX || 0))));
          c &&
            !b &&
            ((a = c.getPlotBox()), (f += a.translateX), (d += a.translateY));
          return { x: f, y: d };
        }
        ...
        constructor(a, b, c) {
          ...
          this.mock = !0;
          this.series = { visible: !0, chart: a, getPlotBox: k.getPlotBox };
          this.target = b || null;
          this.options = c;
        ...
        isInsidePlot() {
          const a = this.plotX,
            ...
            c = this.series.xAxis,
            e = this.series.yAxis,
            d = { x: a, y: b, isInsidePlot: !0, options: {} };
          c && (d.isInsidePlot = g(a) && 0 <= a && a <= c.len);
          e &&
            (d.isInsidePlot = d.isInsidePlot && g(b) && 0 <= b && b <= e.len);
          f(this.series.chart, "afterIsInsidePlot", d);
        ...
        refresh() {
          ...
          b
            ? ((this.x = c.x), (this.plotX = b.toPixels(c.x, !0)))
            : ((this.x = void 0), (this.plotX = c.x));
          a
            ? ((this.y = c.y), (this.plotY = a.toPixels(c.y, !0)))
            : ((this.y = null), (this.plotY = c.y));
        ...
        refreshOptions() {
          ...
          const b = a.xAxis;
          a = a.yAxis;
          this.x = this.options.x = b
            ? (this.options.x = b.toValue(this.plotX, !0))
            : this.plotX;
        ...
        setAxis(a, b) {
          ...
          this.series[b] =
            "object" === typeof a ? a : g(a) ? c[b][a] || c.get(a) : null;
        }
        toAnchor() {
        ...
        translate(a, b, c, e) {
          this.hasDynamicOptions() ||
            ((this.plotX += c), (this.plotY += e), this.refreshOptions());
        }
      }
      ("");
      return c;
  ...
  q(
    ...
    [
      d["Extensions/Annotations/ControlPoint.js"],
      d["Extensions/Annotations/MockPoint.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k) {
      var g;
      (function (f) {
        ...
        function a(a) {
          ...
          var e = a.mock
            ? a.toAnchor()
            : (c.tooltip &&
                c.tooltip.getAnchor.call({ chart: a.series.chart }, a)) || [
                0, 0, 0, 0,
              ];
          e = {
        ...
        function h(a, b) {
          ...
          (b && null !== b.series) ||
            (k.isObject(a)
              ? (b = new n(this.chart, this, a))
              : k.isString(a)
              ? (b = this.chart.get(a) || null)
              : "function" === typeof a &&
                ((b = a.call(b, this)),
                (b = b.series ? b : new n(this.chart, this, a))));
          return b;
        }
        function v(a) {
        ...
        function A(a, b, c, e, f) {
          ...
          this.points.forEach(
            (l, d) => this.transformPoint(a, b, c, e, f, d),
            this
          );
        }
        ...
        function D(a, b, c) {
          this.transformPoint("translate", null, null, a, b, c);
        }
        const r = [];
        f.compose = function (f) {
          k.pushUnique(r, f) &&
            k.merge(!0, f.prototype, {
              addControlPoints: c,
              anchor: a,
  ...
  q(
    ...
    [d["Extensions/Annotations/ControlTarget.js"], d["Core/Utilities.js"]],
    function (d, n) {
      const { merge: k } = n;
      class g {
        constructor(f, c, a, b) {
          ...
          for (d in f)
            (e = c[d]),
              "undefined" === typeof c[d] ||
                (b && -1 !== ["fill", "stroke", "stroke-width"].indexOf(e)) ||
                (a[e] = f[d]);
          return a;
        }
        destroy() {
        ...
        defaultMarkers: {
          ...
          "reverse-arrow": {
            ...
            children: [
              {
                tagName: "path",
                attributes: { d: "M 0 5 L 10 0 L 10 10 Z", "stroke-width": 0 },
              },
            ],
          },
        },
  ...
  q(
    ...
    [
      d["Extensions/Annotations/Controllables/Controllable.js"],
      d["Extensions/Annotations/Controllables/ControllableDefaults.js"],
      d["Core/Globals.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k, g) {
      ...
      const { defaultMarkers: b } = n,
        { addEvent: m, defined: e, extend: h, merge: v, uniqueKey: p } = g,
        A = [],
        t = f("marker-end"),
        x = f("marker-start"),
        D = "rgba(192,192,192," + (k.svg ? 0.0001 : 0.002) + ")";
      class r extends d {
        static compose(b, e) {
        ...
        toD() {
          ...
          let f = a[0],
            ...
            p = 0;
          if (d)
            for (c.push(["M", d.x, d.y]); ++p < b && e; )
              (f = a[p]),
                (e = f.command || "L"),
                (d = this.anchor(f).absolutePosition),
                "M" === e
                  ? c.push([e, d.x, d.y])
                  : "L" === e
                  ? c.push([e, d.x, d.y])
          ...
          return e && this.graphic
            ? this.chart.renderer.crispLine(c, this.graphic.strokeWidth())
            : null;
        }
        shouldBeDrawn() {
        ...
        render(a) {
          ...
          super.render();
          h(this.graphic, { markerStartSetter: x, markerEndSetter: t });
        ...
        redraw(a) {
          if (this.graphic) {
            const b = this.toD(),
              c = a ? "animate" : "attr";
            b
              ? (this.graphic[c]({ d: b }), this.tracker[c]({ d: b }))
          ...
          ["markerStart", "markerEnd"].forEach(function (e) {
            ...
            if (d) {
              for (r in f)
                if (
                  ((l = f[r]),
                  (d === (l.attributes && l.attributes.id) || d === l.id) &&
                    "marker" === l.tagName)
                ) {
                  h = l;
                  break;
  ...
  q(
    ...
    [
      d["Extensions/Annotations/Controllables/Controllable.js"],
      d["Extensions/Annotations/Controllables/ControllablePath.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k) {
      ({ merge: k } = k);
      ...
      g.attrsMap = k(n.attrsMap, { width: "width", height: "height" });
      return g;
    }
  );
  q(
    ...
    function (d, n, k) {
      ...
      class c extends d {
        ...
        getDistanceFromLine(a, b, c, e) {
          return (
            Math.abs(
              (b.y - a.y) * c - (b.x - a.x) * e + b.x * a.y - b.y * a.x
        ...
        getAttrs(a, b) {
          ...
          b < c && (e += 180);
          c = this.getRY();
          return { cx: b, cy: a, rx: p, ry: c, angle: e };
        }
        getRY() {
          const a = this.getYAxis();
          return f(a)
            ? Math.abs(a.toPixels(this.options.ry) - a.toPixels(0))
            : this.options.ry;
        }
        getYAxis() {
        ...
        redraw(a) {
          if (this.graphic) {
            const c = this.getAbsolutePosition(this.points[0]);
            var b = this.getAbsolutePosition(this.points[1]);
            b = this.getAttrs(c, b);
            if (c)
              this.graphic[a ? "animate" : "attr"]({
                cx: b.cx,
                cy: b.cy,
                rx: b.rx,
                ry: b.ry,
      ...
      function f(a, c, e, f, d) {
        ...
        b(p) &&
          ...
          d > c + f
            ...
            : p < a
            ? h.push(["L", a, c + f / 2])
            : p > a + e && h.push(["L", a + e, c + f / 2]));
        return h || [];
      }
      const { format: c } = n,
        { extend: a, isNumber: b, pick: m } = g,
        e = [];
      class h extends d {
        static alignedPosition(a, b) {
          const c = a.align,
            e = a.verticalAlign;
          let f = (b.x || 0) + (a.x || 0),
            d = (b.y || 0) + (a.y || 0),
          ...
          return { x: Math.round(f), y: Math.round(d) };
        }
        static compose(a) {
        ...
        static justifiedOptions(a, b, c, e) {
          ...
          m = c + h;
          0 > m &&
            ("right" === f ? (b.align = "left") : (b.x = (b.x || 0) - m));
          m = c + l.width - h;
          m > a.plotWidth &&
            ("left" === f
              ? (b.align = "right")
              : (b.x = (b.x || 0) + a.plotWidth - m));
          m = e + h;
          0 > m &&
            ("bottom" === d
              ? (b.verticalAlign = "top")
        ...
        render(a) {
          ...
          this.annotation.chart.styledMode ||
            ("contrast" === e.color &&
              (e.color = this.annotation.chart.renderer.getContrast(
                -1 < h.shapesWithoutBackground.indexOf(b.shape)
                  ? "#FFFFFF"
                  : b.backgroundColor
              )),
            this.graphic.css(b.style).shadow(b.shadow));
          b.className && this.graphic.addClass(b.className);
        ...
        redraw(a) {
          ...
          f
            ? (f.attr({
                text: e
                  ? c(String(e), d.getLabelConfig(), this.annotation.chart)
                  : b.formatter.call(d, this),
              }),
              (b = this.anchor(d)),
              (e = this.position(b))
                ? ((f.alignAttr = e),
                  (e.anchorX = b.absolutePosition.x),
                  (e.anchorY = b.absolutePosition.y),
                  f[a ? "animate" : "attr"](e))
                : f.attr({ x: 0, y: -9999 }),
              (f.placed = !!e),
              super.redraw(a))
        ...
        position(b) {
          ...
          if (c && b) {
            const { width: p = 0, height: v = 0 } = c;
            g.distance && f
              ? (u = f.getPosition.call(
                  {
                    chart: e,
              ...
              : g.positioner
              ? (u = g.positioner.call(this))
              : ((f = { x: r.x, y: r.y, width: 0, height: 0 }),
                (u = h.alignedPosition(a(g, { width: p, height: v }), f)),
                "justify" === this.options.overflow &&
                  (u = h.alignedPosition(h.justifiedOptions(e, c, g, u), f)));
            g.crop &&
              ((c = u.x - e.plotLeft),
              (g = u.y - e.plotTop),
              (b = e.isInsidePlot(c, g) && e.isInsidePlot(c + p, g + v)));
          }
          return b ? u : null;
        }
      }
  ...
  q(
    ...
    function (d, n) {
      class k extends d {
        ...
        render(d) {
          const f = this.attrsFromOptions(this.options),
            c = this.options;
          this.graphic = this.annotation.chart.renderer
            .image(c.src, 0, -9e9, c.width, c.height)
            .attr(f)
            .add(d);
        ...
        redraw(d) {
          if (this.graphic) {
            ...
            if ((f = n.prototype.position.call(this, f)))
              this.graphic[d ? "animate" : "attr"]({ x: f.x, y: f.y });
            else this.graphic.attr({ x: 0, y: -9e9 });
      ...
      k.attrsMap = { width: "width", height: "height", zIndex: "zIndex" };
      return k;
    }
  );
  ...
  q(
    ...
    [d["Core/Utilities.js"]],
    function (d) {
      const { defined: n, isNumber: k, pick: g } = d,
        f = {
  ...
  q(
    ...
    [
      d["Extensions/Annotations/NavigationBindingsUtilities.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n) {
      const { getAssignedAxis: k } = d,
        { isNumber: g, merge: f } = n;
      return {
        lang: {
          navigation: {
            popup: {
              ...
              steps: [
                function (c, a) {
                  ...
                  if (g(b.xAxis) && g(b.yAxis)) {
                    ...
                    d = Math.max(
                      Math.sqrt(
                        Math.pow(d ? b - c.chartX : a - c.chartX, 2) +
                          Math.pow(d ? a - c.chartY : b - c.chartY, 2)
                      ),
                      5
                    );
                  }
                ...
                if (c && a)
                  return this.chart.addAnnotation(
                    f(
                      ...
                      b.annotationsOptions,
                      b.bindings.ellipseAnnotation.annotationOptions
                    )
                  );
              },
              steps: [
                ...
                function (c, a) {
                  ...
                  c = a.getDistanceFromLine(b, d, c.chartX, c.chartY);
                  b = a.getYAxis();
                ...
                if (c && a)
                  return this.chart.addAnnotation(
                    f(
                      ...
                      b.annotationsOptions,
                      b.bindings.labelAnnotation.annotationsOptions
                    )
                  );
              },
            },
  ...
  q(
    ...
    [
      d["Core/Chart/ChartNavigationComposition.js"],
      d["Core/Defaults.js"],
      d["Core/FormatUtilities.js"],
      d["Core/Globals.js"],
      d["Extensions/Annotations/NavigationBindingsDefaults.js"],
      d["Extensions/Annotations/NavigationBindingsUtilities.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k, g, f, c, a) {
      ...
      function h() {
        ...
        a &&
          a.navigation &&
          a.navigation.bindings &&
          ((this.navigationBindings = new F(this, a.navigation)),
              ...
              if ((e = c.querySelectorAll("." + e)))
                for (let c = 0; c < e.length; c++) {
                  ...
                  "normal" === a.noDataState
                    ? -1 !== f.indexOf("highcharts-disabled-btn") &&
                      d.classList.remove("highcharts-disabled-btn")
                    : b
                    ? -1 !== f.indexOf("highcharts-disabled-btn") &&
                      d.classList.remove("highcharts-disabled-btn")
                    : -1 === f.indexOf("highcharts-disabled-btn") &&
                      (d.className += " highcharts-disabled-btn");
                }
            });
          }
        }
      ...
      function t(a) {
          ...
          d !== b
            ? (e.deselectAnnotation(),
              ...
              z(e, "showPopup", {
                ...
                onSubmit: function (a) {
                  if ("remove" === a.actionType)
                    (e.activeAnnotation = !1), e.chart.removeAnnotation(b);
                  else {
                    const c = {};
                    e.fieldsToOptions(a.fields, c);
                    e.deselectAnnotation();
                    a = c.typeOptions;
                    "measure" === b.options.type &&
                      ((a.crosshairY.enabled = 0 !== a.crosshairY.strokeWidth),
        ...
        const c =
          a.prototype.defaultOptions.events &&
        ...
        G(!0, a.prototype.defaultOptions.events, {
          ...
          touchend: function (a) {
            (e &&
              4 <=
                Math.sqrt(
                  Math.pow(e - a.changedTouches[0].clientX, 2) +
                    Math.pow(d - a.changedTouches[0].clientY, 2)
                )) ||
              b.call(this, a);
          },
        });
      }
      const { setOptions: x } = n,
        { format: D } = k,
        { doc: r, win: l } = g,
        { getFieldType: u } = c,
        {
      ...
      class F {
        static compose(b, c) {
          ...
          a.pushUnique(J, c) &&
            (B(c, "destroy", e), B(c, "load", h), B(c, "render", v));
          a.pushUnique(J, F) &&
            (B(F, "closePopup", p), B(F, "deselectButton", A));
        ...
        constructor(a, b) {
          ...
          this.container.length ||
            (this.container = r.getElementsByClassName(
              this.options.bindingsClassName || ""
            ));
        }
        initEvents() {
          ...
          y(e.events || {}, (b, c) => {
            q(b) && a.eventsToUnbind.push(B(a, c, b, { passive: !1 }));
          });
          a.eventsToUnbind.push(
            B(b.container, "click", function (c) {
              !b.cancelClick &&
        ...
        bindingsButtonClick(a, b, c) {
          ...
          this.selectedButtonElement &&
            ...
            z(this, "deselectButton", { button: this.selectedButtonElement }),
            this.nextEvent &&
              (this.currentUserDetails &&
                "annotations" === this.currentUserDetails.coll &&
                e.removeAnnotation(this.currentUserDetails),
              (this.mouseMoveEvent = this.nextEvent = !1)));
          f
            ? ((this.selectedButton = b),
              (this.selectedButtonElement = a),
              z(this, "selectButton", { button: a }),
              b.init && b.init.call(this, a, c),
              (b.start || b.steps) &&
                e.renderer.boxWrapper.addClass("highcharts-draw-mode"))
            : (e.stockTools && e.stockTools.toggleButtonActiveClass(a),
              d.removeClass("highcharts-draw-mode"),
              (this.mouseMoveEvent = this.nextEvent = !1),
          ...
          d &&
            ...
            (this.nextEvent
              ? (this.nextEvent(c, this.currentUserDetails),
                this.steps &&
                  (this.stepIndex++,
                  d.steps[this.stepIndex]
                    ? (this.mouseMoveEvent = this.nextEvent =
                        d.steps[this.stepIndex])
                    : (z(this, "deselectButton", {
                        button: this.selectedButtonElement,
                      }),
                      a.removeClass("highcharts-draw-mode"),
                      d.end && d.end.call(this, c, this.currentUserDetails),
                      (this.mouseMoveEvent = this.nextEvent = !1),
                      (this.selectedButton = null))))
              : (this.currentUserDetails = d.start.call(this, c)) && d.steps
              ? ((this.stepIndex = 0),
                (this.steps = !0),
                (this.mouseMoveEvent = this.nextEvent =
                  d.steps[this.stepIndex]))
        ...
        bindingsContainerMouseMove(a, b) {
          this.mouseMoveEvent &&
            this.mouseMoveEvent(b, this.currentUserDetails);
        }
        fieldsToOptions(a, b) {
          y(a, (a, c) => {
        ...
        annotationToFields(a) {
          function b(c, e, f, l, m) {
            ...
            f &&
              c &&
              -1 === h.indexOf(e) &&
              (0 <= (f.indexOf && f.indexOf(e)) || f[e] || !0 === f) &&
              (w(c)
                ? ((l[e] = []),
                  c.forEach((a, c) => {
                    E(a)
                ...
                : E(c)
                ? ((r = {}),
                  w(l) ? (l.push(r), (r[e] = {}), (r = r[e])) : (l[e] = r),
                  y(c, (a, c) => {
                    b(a, c, 0 === e ? f : d[e], r, e);
                  }))
                : "format" === e
                ? (l[e] = [D(c, a.labels[0].points[0]).toString(), "text"])
                : w(l)
                ? l.push([c, u(m, c)])
                : (l[e] = [c, u(e, c)]));
          }
          const c = a.options,
            ...
            f = K(
              c.type,
              c.shapes && c.shapes[0] && c.shapes[0].type,
              c.labels && c.labels[0] && c.labels[0].type,
              "label"
            ),
            h = F.annotationsNonEditable[c.langKey] || [],
            l = { langKey: c.langKey, type: f };
          y(c, (a, h) => {
            "typeOptions" === h
              ? ((l[h] = {}),
                y(c[h], (a, c) => {
        ...
        getButtonEvents(a, b) {
          ...
          this.getClickedClassNames(a, b).forEach((a) => {
            c.boundClassNames[a[0]] &&
              !e &&
              (e = { events: c.boundClassNames[a[0]], button: a[1] });
          });
          return e;
        }
        update(a) {
  ...
  q(
    d,
    "Shared/BaseForm.js",
    [d["Core/Renderer/HTML/AST.js"], d["Core/Utilities.js"]],
    function (d, n) {
      const { addEvent: k, createElement: g } = n;
      class f {
        constructor(c, a) {
          this.iconsURL = a;
        ...
        createPopupContainer(c, a = "highcharts-popup highcharts-no-tooltip") {
          return g("div", { className: a }, void 0, c);
        }
        addCloseButton(c = "highcharts-popup-close") {
          const a = this,
            b = this.iconsURL,
            d = g("div", { className: c }, void 0, this.container);
          d.style["background-image"] =
            "url(" +
            (b.match(/png|svg|jpeg|jpg|gif/gi) ? b : b + "close.svg") +
            ")";
        ...
        showPopup(c = "highcharts-annotation-toolbar") {
          ...
          0 <= a.className.indexOf(c) &&
            (a.classList.remove(c), a.removeAttribute("style"));
          a.appendChild(b);
        ...
        if (d) {
          ...
          m(t, (c, f) => {
            ...
            b(c) &&
              (!a(c) || (a(c) && b(c[0]))
                ? ((v = l[f] || f),
                  v.match(/\d/g) || x.push([!0, v, e]),
                  k.call(this, e, d, p, c, x, !1))
                : x.push([this, p, "annotation", e, c]));
          });
          D &&
            (h(x, (a) => (a[1].match(/format/g) ? -1 : 1)),
            f && x.reverse(),
            x.forEach((a) => {
              !0 === a[0]
                ? c(
                    ...
                    void 0,
                    a[2]
                  ).appendChild(g.createTextNode(a[1]))
                : ((a[4] = { value: a[4][0], type: a[4][1] }),
                  r.apply(a[0], a.splice(1)));
            }));
        }
      }
      const { doc: g, isFirefox: f } = d,
        {
          createElement: c,
          isArray: a,
          isObject: b,
      ...
      return {
        addForm: function (a, b, e, d) {
          if (a) {
            ...
            this.addButton(
              l,
              d ? h.addButton || "Add" : h.saveButton || "Save",
              d ? "add" : "save",
              f,
              e
            );
        ...
        addToolbar: function (a, b, d) {
          const f = this.lang,
            h = this.container,
            m = this.showForm;
          -1 === h.className.indexOf("highcharts-annotation-toolbar") &&
            (h.className += " highcharts-annotation-toolbar");
          a && (h.style.top = a.plotTop + 10 + "px");
          c("span", void 0, void 0, h).appendChild(
            g.createTextNode(
              e(f[b.langKey] || b.langKey, b.shapes && b.shapes[0].type, "")
            )
          );
          let r = this.addButton(h, f.removeButton || "Remove", "remove", h, d);
          r.className += " highcharts-annotation-remove-button";
          r.style["background-image"] = "url(" + this.iconsURL + "destroy.svg)";
  ...
  q(
    ...
    function (d, n, k, g, f) {
      function c(a) {
        ...
        a = l("div", { className: "highcharts-popup-rhs-col" }, void 0, a);
        l("div", { className: "highcharts-popup-rhs-col-wrapper" }, void 0, a);
      ...
      function a(a, c, e, f) {
        ...
        if (a || !e) {
          ...
          g.forEach((c) => {
            const { indicatorFullName: e, indicatorType: f, series: m } = c;
            G = l("li", { className: "highcharts-indicator-list" }, void 0, k);
              ...
              r(G, c, function () {
                const c = y.parentNode.children[1];
                {
                  ...
                  l(
                    ...
                    void 0,
                    y
                  ).appendChild(w.createTextNode(A(m, f).indicatorFullName));
                  l(
                    "input",
                    { type: "hidden", name: "highcharts-type-" + f, value: f },
                    void 0,
                    y
                  );
                  t.call(
                    ...
                    y,
                    m,
                    m.linkedParent && m.linkedParent.options.id
                  );
                  c.volumeSeriesID &&
                    t.call(
                      h,
                      ...
                      y,
                      m,
                      m.linkedParent && c.volumeSeriesID
                    );
                ...
                u &&
                  ...
                  l(
                    ...
                    void 0,
                    y
                  ).setAttribute("highcharts-data-series-id", m.options.id);
              });
            });
          });
          0 < k.childNodes.length
            ? k.childNodes[0].click()
            : u ||
              (d.setElementHTML(
                y.parentNode.children[0],
                m.noFilterMatch || ""
              ),
              (y.parentNode.children[1].style.display = "none"));
        }
      }
      function b(a, c, d, f, l) {
        if (a) {
          ...
          z(d, (d, E) => {
            ...
            u(d) &&
              r &&
              (H(d) && (m.call(this, r, f, l, {}), b.call(this, a, r, d, f, l)),
              r in I
                ? ((r = e.call(this, f, r, l)), h.call(this, a, c, r, f, E, d))
                : "params.volumeSeriesID" === r ||
                  B(d) ||
                  m.call(this, r, f, l, { value: d, type: "number" }));
          });
        }
      }
      function m(b, c) {
        ...
        d = l("div", { className: "highcharts-input-wrapper" }, void 0, d);
      ...
      function e(a, b, c) {
        ...
        const d = this.lang;
        l("label", { htmlFor: a }, null, c).appendChild(
          w.createTextNode(d[e] || b)
        );
        c = l(
          "select",
          {
        ...
        "series" === b || "volume" === b
          ? a.series.forEach((a) => {
              ...
              "highcharts-navigator-series" !== e.id &&
                e.id !== (h && h.options && h.options.id) &&
                (u(f) || "volume" !== b || "column" !== a.type || (f = e.id),
                l("option", { value: e.id }, void 0, c).appendChild(
                  w.createTextNode(d)
                ));
            })
          : e &&
            d &&
            C[d + "-" + e].forEach((a) => {
              l("option", { value: a }, void 0, c).appendChild(
                w.createTextNode(a)
              );
            });
        u(f) && (c.value = f);
      ...
      function v(a, b) {
        const c = this.chart && this.chart.options.lang,
          e =
            ...
            c.navigation &&
            c.navigation.popup &&
            c.navigation.popup.indicatorAliases,
          d = [];
        let f;
        z(a, (a, c) => {
          var h = a && a.options;
          if (a.params || (h && h.params)) {
            const { indicatorFullName: l, indicatorType: m } = A(a, c);
            if (b) {
              if (
                ((c = b.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")),
                (c = new RegExp(c, "i")),
                ...
                (f = { indicatorFullName: l, indicatorType: m, series: a }),
                  d.push(f);
            } else
              (f = { indicatorFullName: l, indicatorType: m, series: a }),
                d.push(f);
      ...
      function A(a, b) {
        ...
        return { indicatorFullName: e, indicatorType: b };
      }
      function t(a, b, c, d, f, l) {
        c &&
          ((a = e.call(this, a, b, d)),
          h.call(this, c, b, a, void 0, void 0, void 0, f),
          u(l) && (a.value = l));
      }
      const { doc: w } = n,
        { seriesTypes: D } = g,
      ...
      return {
        addForm: function (b, e, d) {
          ...
          if (b) {
            ...
            var h = this.container.querySelectorAll(
                ...
                b(e, a, function () {
                  {
                    ...
                    for (let c = 0; c < b.length; c++)
                      b[c].classList.remove("highcharts-tab-item-active"),
  ...
  q(
    ...
    [
      d["Shared/BaseForm.js"],
      d["Core/Globals.js"],
      d["Core/Defaults.js"],
      d["Extensions/Annotations/Popup/PopupAnnotations.js"],
      d["Extensions/Annotations/Popup/PopupIndicators.js"],
      d["Extensions/Annotations/Popup/PopupTabs.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k, g, f, c, a) {
      function b(a, b) {
        ...
        c.forEach((a) => {
          ...
          a.getAttribute("highcharts-data-series-id")
            ? (f.seriesId = a.value)
            : b
            ? (f.fields[b] = a.value)
            : (f.type = a.value);
        ...
        e.forEach((a) => {
          var b = a.id;
          "highcharts-select-series" !== b &&
            "highcharts-select-volume" !== b &&
            ((b = b.split("highcharts-select-")[1]), (f.fields[b] = a.value));
        });
        a &&
          (f.fields["params.volumeSeriesID"] = a.getAttribute("value") || "");
        return f;
      }
      const { doc: m } = n,
        { getOptions: e } = k,
        { addEvent: h, createElement: v, extend: p, fireEvent: A, pick: t } = a;
      class w extends d {
        constructor(a, b, c) {
          super(a, b);
          this.chart = c;
          ...
          h(this.container, "mousedown", () => {
            const a =
              c &&
              c.navigationBindings &&
              c.navigationBindings.activeAnnotation;
            if (a) {
              a.cancelClick = !0;
              const b = h(m, "click", () => {
                setTimeout(() => {
        ...
        addInput(a, b, c, e) {
          ...
          d = d[d.length - 1];
          const f = this.lang;
          b = "highcharts-" + b + "-" + t(e.htmlFor, d);
          d.match(/^\d+$/) ||
            v(
              "label",
              { htmlFor: b, className: e.labelClassName },
              void 0,
              c
            ).appendChild(m.createTextNode(f[d] || d));
          c = v(
            "input",
            {
              name: b,
        ...
        closeButtonEvents() {
          if (this.chart) {
            ...
            A(a, "closePopup");
            a &&
              a.selectedButtonElement &&
              A(a, "deselectButton", { button: a.selectedButtonElement });
          } else super.closeButtonEvents();
        }
        addButton(a, c, e, d, f) {
          const l = v("button", void 0, void 0, a);
        ...
        showForm(a, b, c, e) {
          b &&
            (this.showPopup(),
            "indicators" === a && this.indicators.addForm.call(this, b, c, e),
            "annotation-toolbar" === a &&
              this.annotations.addToolbar.call(this, b, c, e),
            "annotation-edit" === a &&
              this.annotations.addForm.call(this, b, c, e),
            "flag" === a && this.annotations.addForm.call(this, b, c, e, !0),
            (this.type = a),
            (this.container.style.height = this.container.offsetHeight + "px"));
        }
      }
      p(w.prototype, { annotations: g, indicators: f, tabs: c });
      return w;
    }
  );
  q(
    ...
    [d["Extensions/Annotations/Popup/Popup.js"], d["Core/Utilities.js"]],
    function (d, n) {
      function k() {
      ...
      function f(a, b) {
        this.inClass(b.target, "highcharts-popup") ||
          a.apply(this, Array.prototype.slice.call(arguments, 1));
      }
      const { addEvent: c, wrap: a } = n,
        b = [];
      return {
  ...
  q(
    ...
    [
      ...
      d["Extensions/Annotations/AnnotationChart.js"],
      d["Extensions/Annotations/AnnotationDefaults.js"],
      d["Extensions/Annotations/Controllables/ControllableRect.js"],
      d["Extensions/Annotations/Controllables/ControllableCircle.js"],
      d["Extensions/Annotations/Controllables/ControllableEllipse.js"],
      d["Extensions/Annotations/Controllables/ControllablePath.js"],
      d["Extensions/Annotations/Controllables/ControllableImage.js"],
      d["Extensions/Annotations/Controllables/ControllableLabel.js"],
      d["Extensions/Annotations/ControlPoint.js"],
      d["Extensions/Annotations/ControlTarget.js"],
      d["Extensions/Annotations/EventEmitter.js"],
      d["Extensions/Annotations/MockPoint.js"],
      d["Extensions/Annotations/NavigationBindings.js"],
      d["Extensions/Annotations/Popup/PopupComposition.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k, g, f, c, a, b, m, e, h, v, p, A, t, q) {
      ...
      const { getDeferredAnimation: l } = d,
        {
      ...
      class C extends v {
        ...
        redrawItem(a, b) {
          a.linkPoints();
          a.shouldBeDrawn()
            ? (a.graphic || this.renderItem(a),
              a.redraw(x(b, !0) && a.graphic.placed),
              a.points.length && w(a))
            : this.destroyItem(a);
        }
        redrawItems(a, b) {
        ...
        renderItem(a) {
          a.render(
            "label" === a.itemType ? this.labelsGroup : this.shapesGroup
          );
        }
        renderItems(a) {
          let b = a.length;
        ...
        setClipAxes() {
          const a = this.chart.xAxis,
            ...
            c = (this.options.labels || [])
              ...
              .reduce((c, e) => {
                e = e && (e.point || (e.points && e.points[0]));
        ...
        setOptions(a) {
          this.options = z(this.defaultOptions, a);
        }
        setVisibility(a) {
          const b = this.options,
          ...
          e ||
            ...
            c.activeAnnotation === this &&
              c.popup &&
              "annotation-toolbar" === c.popup.type &&
              H(c, "closePopup"));
          b.visible = e;
        }
        update(a, b) {
      ...
      C.ControlPoint = e;
      C.MockPoint = p;
      C.shapesMap = { rect: g, circle: f, ellipse: c, path: a, image: b };
      C.types = {};
  ...
  q(
    ...
    [
      d["Extensions/Annotations/Annotation.js"],
      d["Extensions/Annotations/MockPoint.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k) {
      ...
      class g extends d {
        ...
        init() {
          var d = this.options;
          d.shapes
            ? (delete d.labelOptions,
              (this.basicType =
                (d = d.shapes[0].type) && "path" !== d ? d : "rectangle"))
            : (delete d.shapes, (this.basicType = "label"));
        ...
        circle: [
          {
            ...
            events: {
              drag: function (d, c) {
                ...
                c.setRadius(
                  Math.max(c.options.r + d.y / Math.sin(Math.PI / 4), 5)
                );
                a &&
                  a[0] &&
                  ((a[0].r = c.options.r), (a[0].point = c.options.point));
                c.redraw(!1);
              },
            },
          },
            ...
            positioner: function (d) {
              ...
              return {
                x:
                  ...
                  d.ry * Math.sin((d.angle * Math.PI) / 180),
                y:
                  d.cy -
                  this.graphic.height / 2 -
                  d.ry * Math.cos((d.angle * Math.PI) / 180),
              };
            },
            events: {
              drag: function (d, c) {
        ...
        addControlPoints() {
          this.getControlPointsOptions().forEach(function (a, b) {
            b = new n(
              this.chart,
              this,
              f(this.options.controlPointOptions, a.controlPoint),
              b
            );
      ...
      c.prototype.defaultOptions = f(d.prototype.defaultOptions, {
        ...
        controlPointOptions: {
          positioner: function (a) {
            ...
            return { x: a.x - b.width / 2, y: a.y - b.height / 2 };
          },
          events: {
            drag: function (a, b) {
              if (
                b.chart.isInsidePlot(
                  a.chartX - b.chart.plotLeft,
                  a.chartY - b.chart.plotTop,
                  { visiblePlotOnly: !0 }
                )
              ) {
  ...
  q(
    ...
    [
      d["Extensions/Annotations/Annotation.js"],
      d["Extensions/Annotations/Types/CrookedLine.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k) {
      const { merge: g } = k;
      ...
      class a extends k {
        ...
        addControlPoints() {
          ...
          a = new n(
            this.chart,
            this,
            c(a.controlPointOptions, d.heightControlPoint),
            2
          );
        ...
        addLine() {
          const a = this.initShape(
            c(this.options.typeOptions.line, {
              type: "path",
              points: [
                this.points[0],
                this.points[1],
        ...
        addBackground() {
          const a = this.initShape(
            c(this.options.typeOptions.background, {
              type: "path",
      ...
      a.prototype.defaultOptions = c(k.prototype.defaultOptions, {
        typeOptions: {
          ...
          heightControlPoint: {
            ...
            events: {
              drag: function (a, c) {
                c.chart.isInsidePlot(
                  a.chartX - c.chart.plotLeft,
                  a.chartY - c.chart.plotTop,
                  { visiblePlotOnly: !0 }
                ) &&
                  (c.translateHeight(this.mouseMoveToTranslation(a).y),
                  c.redraw(!1));
              },
            },
          },
          ...
          events: {
            drag: function (a, c) {
              c.chart.isInsidePlot(
                ...
                ((a = this.mouseMoveToTranslation(a)),
                c.translateSide(a.x, a.y, !!this.index),
                c.redraw(!1));
            },
          },
        },
      ...
      class c extends n {
        static edgePoint(a, b) {
          return function (d) {
            ...
            let f = d.points;
            if ("horizontalLine" === e || "verticalLine" === e)
              f = [
                f[0],
                new k(d.chart, f[0].target, {
                  x: f[0].x + +("horizontalLine" === e),
                  y: f[0].y + +("verticalLine" === e),
        ...
        static findEdgePoint(a, b) {
          ...
          q = 0 > p ? t : q;
          const w = 0 > n ? e : f;
          t = { x: 0 === p ? g.x : q, y: 0 === n ? g.y : w };
          0 !== p &&
            0 !== n &&
            ((p = c.findEdgeCoordinate(g, b, "y", q)),
            (g = c.findEdgeCoordinate(g, b, "x", w)),
            p >= e && p <= f ? ((t.x = q), (t.y = p)) : ((t.x = g), (t.y = w)));
          t.x -= d.plotLeft;
          t.y -= d.plotTop;
        ...
        addShapes() {
          ...
          b = this.initShape(f(a.line, { type: "path", points: b }), 0);
          a.line = b.options;
        }
      }
  ...
  q(
    ...
    function (d, n, k, g) {
      function f(a, b, c, d) {
        const e = [];
        for (let f = 1; f <= b; f++)
          e.push(["A", a / 2, a / 2, 0, 1, 1, c + f * a, d]);
        return e;
      }
      const { merge: c, isNumber: a, defined: b } = g;
      class m extends n {
        init(a, c, d) {
          b(c.yAxis) &&
            c.points.forEach((a) => {
        ...
        getPath() {
          return [["M", this.startX, this.y]].concat(
            f(this.pixelInterval, this.numberOfCircles, this.startX, this.y)
          );
        }
        addShapes() {
          const a = this.options.typeOptions;
          this.setPathProperties();
          const b = this.initShape(
            c(a.line, {
              type: "path",
              d: this.getPath(),
        ...
        addControlPoints() {
          const a = this.options,
            b = a.typeOptions;
          a.controlPointOptions.style.cursor = this.chart.inverted
            ? "ns-resize"
            : "ew-resize";
        ...
        setPathProperties() {
          ...
          if (c) {
            ...
            b &&
              d &&
              ((c = a(g) ? m.toPixels(g) : m.top + m.height),
              (b = a(b) ? f.toPixels(b) : f.left),
              (m = a(d) ? f.toPixels(d) : f.left + 30),
              (m = Math.round(Math.max(Math.abs(m - b), 2))),
              (d = Math.floor(f.len / m) + 2),
              (this.startX = b - (Math.floor((b - f.left) / m) + 1) * m),
              (this.y = c),
              (this.pixelInterval = m),
              (this.numberOfCircles = d));
          }
        }
        redraw(a) {
          this.setPathProperties();
          ...
          controlPointOptions: [
            {
              positioner: function (a) {
                return {
                  x:
                    a.anchor(a.points[0]).absolutePosition.x -
                    this.graphic.width / 2,
            ...
            },
            {
              positioner: function (a) {
                return {
                  x:
                    a.anchor(a.points[1]).absolutePosition.x -
                    this.graphic.width / 2,
                  y: a.y - this.graphic.height,
                };
              },
  ...
  q(
    ...
    [
      d["Extensions/Annotations/Annotation.js"],
      d["Extensions/Annotations/MockPoint.js"],
      d["Extensions/Annotations/Types/Tunnel.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k, g) {
      function f(a, c) {
        return function () {
          ...
          if (!b.startRetracements || !b.endRetracements) return [];
          ...
          c &&
            ((f = this.anchor(b.endRetracements[a - 1]).absolutePosition),
            (b = this.anchor(b.startRetracements[a - 1]).absolutePosition),
            d.push(
              ["L", Math.round(f.x), Math.round(f.y)],
      ...
      class a extends k {
        ...
        linkRetracementPoint(a, c, d, f) {
          ...
          b
            ? ((b.options.x = c), (b.options.y = d), b.refresh())
            : (f[a] = new n(this.chart, this, {
                x: c,
                y: d,
                xAxis: e.xAxis,
                yAxis: e.yAxis,
        ...
        addShapes() {
          a.levels.forEach(function (a, c) {
            const {
              backgroundColors: b,
              lineColor: d,
              lineColors: g,
            } = this.options.typeOptions;
            this.initShape({ type: "path", d: f(c), stroke: g[c] || d }, c);
            0 < c &&
              this.initShape({
                type: "path",
                fill: b[c - 1],
      ...
      a.prototype.defaultOptions = c(k.prototype.defaultOptions, {
        typeOptions: {
          height: 2,
          backgroundColors:
            "rgba(130, 170, 255, 0.4);rgba(139, 191, 216, 0.4);rgba(150, 216, 192, 0.4);rgba(156, 229, 161, 0.4);rgba(162, 241, 130, 0.4);rgba(169, 255, 101, 0.4)".split(
              ";"
            ),
          lineColor: "#999999",
          lineColors: [],
  ...
  q(
    ...
    [
      ...
      d["Extensions/Annotations/ControlPoint.js"],
      d["Extensions/Annotations/Types/CrookedLine.js"],
      d["Extensions/Annotations/Types/InfinityLine.js"],
      d["Extensions/Annotations/MockPoint.js"],
      d["Core/Utilities.js"],
    ],
    function (d, n, k, g, f, c) {
      function a(a, b, c) {
        return function (d) {
          ...
          const h = d[0].series.xAxis.toValue(
            d[0].plotX +
              (e.inverted ? e.plotTop : e.plotLeft) +
              c * (1 < d.length ? d[1].plotX - d[0].plotX : 0)
          );
          d = [
            new f(e, d[0].target, {
              x: h,
      ...
      class m extends k {
        addShapes() {
          ...
          for (let e = 0; 11 > e; e++) {
            ...
            this.initShape(
              b(this.options.typeOptions.line, { type: "path", points: f }),
              e
            );
          }
        }
        addControlPoints() {
          ...
          a = new n(
            this.chart,
            this,
            b(a.controlPointOptions, c.controlPointOptions),
            0
          );
          this.controlPoints.push(a);
        ...
        typeOptions: {
          ...
          controlPointOptions: {
            positioner: function () {
              ...
              c = c[0](d).x;
              f = (f + g) / 2;
              this.chart.inverted && ([c, f] = [f, c]);
              return { x: a + c - b.width / 2, y: m + f - b.height / 2 };
            },
            events: {
              drag: function (a, b) {
                b.chart.isInsidePlot(
    ...
    function (d, n, k, g) {
      ...
      class c extends n {
        static outerLineEdgePoint(a) {
          return function (b) {
            const d = b.annotation,
              e = d.points;
            return c.findEdgePoint(
              e[a],
              e[0],
              new k(d.chart, b, d.midPointOptions())
            );
          };
        }
        ...
        static middleLineEdgePoint(a) {
          ...
          return n.findEdgePoint(
            b.points[0],
            new k(b.chart, a, b.midPointOptions())
          );
        }
        midPointOptions() {
          const a = this.points;
        ...
        addLines() {
          this.initShape(
            { type: "path", points: [this.points[0], c.middleLineEdgePoint] },
            0
          );
          this.initShape(
            { type: "path", points: [this.points[1], c.topLineEdgePoint] },
            1
          );
          this.initShape(
            { type: "path", points: [this.points[2], c.bottomLineEdgePoint] },
            2
          );
        }
        addBackgrounds() {
      ...
      c.topLineEdgePoint = c.outerLineEdgePoint(1);
      ...
      class c extends d {
        ...
        addLabels() {
          ...
          this.chart.inverted &&
            ...
            (d = 0),
            (f = "middle"),
            (k = 0 > b.offset ? "right" : "left"));
          b = this.initLabel(g(b, { verticalAlign: f, align: k, x: c, y: d }));
          a.label = b.options;
        }
      }
    ...
    function (d, n, k) {
      ...
      function h(b, c, d, e, f) {
        ...
        c &&
          ("x" === g
            ? 0 === d
              ? (this.startXMin = a(r, h, e))
              : (this.startXMax = a(r, k, e))
            : "y" === g
            ? 0 === d
              ? (this.startYMin = a(l, m, f))
              : (this.startYMax = a(l, n, f))
            : ((this.startXMax = a(r, k, e)), (this.startYMax = a(l, n, f))));
        b &&
          ((this.startXMin = a(r, h, u)),
          (this.startXMax = a(r, k, u)),
          (this.startYMin = a(l, m, p)),
          (this.startYMax = a(l, n, p)),
          (this.offsetY = this.offsetX = 0));
      }
      const { defined: q, extend: p, isNumber: w, merge: t, pick: x } = k;
      class D extends d {
        init(b, c, d) {
          super.init(b, c, d);
          this.resizeY = this.resizeX = this.offsetY = this.offsetX = 0;
          {
            ...
            w(l)
              ? (this.startXMax = this.startXMin + l)
              : (this.startXMax = a(c, this.startXMin, parseFloat(l)));
            w(f)
              ? (this.startYMax = this.startYMin - f)
              : (this.startYMax = a(e, this.startYMin, parseFloat(f)));
            "x" === g
              ? ((this.startYMin = e.toValue(h)),
                (this.startYMax = e.toValue(h + e.len)))
              : "y" === g &&
                ((this.startXMin = c.toValue(d)),
                (this.startXMax = c.toValue(d + c.len)));
          }
          this.addValues();
          this.addShapes();
        }
        ...
        addControlPoints() {
          ...
          q(
            ...
            ("x" === c
              ? (b.style.cursor = a ? "ns-resize" : "ew-resize")
              : "y" === c && (b.style.cursor = a ? "ew-resize" : "ns-resize"));
          a = new n(this.chart, this, this.options.controlPointOptions, 0);
          this.controlPoints.push(a);
          "xy" !== c &&
            ((a = new n(this.chart, this, this.options.controlPointOptions, 1)),
            this.controlPoints.push(a));
        }
        addValues(a) {
          const b = this.options.typeOptions,
          ...
          b.label.enabled &&
            (0 < this.labels.length
              ? (this.labels[0].text = (c && c.call(this)) || f.call(this))
              : this.initLabel(
                  p(
                    {
                      shape: "rect",
        ...
        addBackground() {
          "undefined" !== typeof this.shapePointsOptions()[0].x &&
            this.initShape(
              p(
                { type: "path", points: this.shapePointsOptions() },
        ...
        addCrosshairs() {
          var a = this.chart,
            ...
            d = a.yAxis[b.yAxis],
            e = a.inverted;
          a = { point: this.options.typeOptions.point, type: "path" };
          ...
          b.crosshairX.enabled &&
            (d = [
              ["M", f, h + (k - h) / 2],
              ["L", g, h + (k - h) / 2],
            ]);
          b.crosshairY.enabled &&
            (c = [
              ["M", f + (g - f) / 2, h],
              ["L", f + (g - f) / 2, k],
            ]);
          0 < this.shapes.length
            ? ((this.shapes[0].options.d = d), (this.shapes[1].options.d = c))
            : ((f = t(a, b.crosshairX)),
              (b = t(a, b.crosshairY)),
              this.initShape(p({ d }, f), 0),
              this.initShape(p({ d: c }, b), 1));
        }
        onDrag(a) {
        ...
        resize(a, b, c, d) {
          ...
          "x" === d
            ...
            : (e.translatePoint(a, 0, 1),
              e.translatePoint(a, b, 2),
              e.translatePoint(0, b, 3));
          h.call(this, !1, !0, c, a, b);
        ...
        translate(a, b) {
          this.shapes.forEach((c) => c.translate(a, b));
      ...
      D.prototype.defaultOptions = t(d.prototype.defaultOptions, {
        ...
        controlPointOptions: {
          positioner: function (a) {
            ...
            let n = a.yAxisMax;
            "x" === g &&
              ((n = (m.yAxisMax + m.yAxisMin) / 2),
              0 === b && (f = a.xAxisMin));
            "y" === g &&
              ((f = m.xAxisMin + (m.xAxisMax - m.xAxisMin) / 2),
              0 === b && (n = a.yAxisMin));
            h
              ? ((a = d.toPixels(n)), (b = k.toPixels(f)))
              : ((a = k.toPixels(f)), (b = d.toPixels(n)));
  ...
  q(
    ...
    [d["Core/Globals.js"], d["Extensions/Annotations/Annotation.js"]],
    function (d, n) {
      d.Annotation = n;
