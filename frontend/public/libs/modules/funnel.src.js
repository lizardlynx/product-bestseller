...
(function (factory) {
  ...
  _registerModule(
    ...
    function (Chart, H, SeriesRegistry, U) {
      /* *
       *
       *  Highcharts funnel module
       *
      ...
      class FunnelSeries extends PieSeries {
        ...
        drawDataLabels() {
          ...
          SeriesRegistry.seriesTypes[
            series.options.dataLabels.inside ? "column" : "pie"
  ...
  _registerModule(
    ...
    [
      _modules["Series/Funnel/FunnelSeries.js"],
      _modules["Core/Series/SeriesRegistry.js"],
      _modules["Core/Utilities.js"],
    ],
    function (FunnelSeries, SeriesRegistry, U) {
      /* *
       *
       *  Highcharts funnel module
       *
