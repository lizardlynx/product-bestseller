...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/dumbbell", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
      ...
      const {
        area: {
          prototype: {
            ...
            pointClass: { prototype: areaProto },
          },
        },
  ...
  _registerModule(
    ...
    [
      _modules["Series/AreaRange/AreaRangePoint.js"],
      _modules["Core/Utilities.js"],
    ],
    function (AreaRangePoint, U) {
      /* *
       *
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Series/Dumbbell/DumbbellPoint.js"],
    ...
    function (
      ...
      const {
        seriesTypes: {
          ...
          columnrange: { prototype: columnRangeProto },
        },
      } = SeriesRegistry;
      ...
      class DumbbellSeries extends AreaRangeSeries {
        ...
        getConnectorAttribs(point) {
          ...
          attribs = {
            d: SVGRenderer.prototype.crispLine(
              [
                ["M", point.plotX, pointTop],
                ["L", point.plotX, pointBottom],
              ],
              connectorWidth,
              "ceil"
            ),
        ...
        drawConnector(point) {
          const series = this,
            ...
            verb =
              point.connector && series.chart.pointCount < animationLimit
                ? "animate"
                : "attr";
          if (!point.connector) {
  ...
  _registerModule(
    _modules,
    "masters/modules/dumbbell.src.js",
    [],
    function () {}
  );
});
