...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/annotations-advanced", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
    ...
    function (U) {
      ...
      function chartCallback() {
        ...
        chart.options.annotations.forEach((annotationOptions, i) => {
          if (
            ...
            !chart.annotations.some(
              (annotation) => annotation.options === annotationOptions
            )
          ) {
      ...
      function chartRemoveAnnotation(idOrAnnotation) {
        const annotations = this.annotations,
          annotation =
            idOrAnnotation.coll === "annotations"
              ? idOrAnnotation
        ...
        function compose(AnnotationClass, ChartClass, PointerClass) {
          if (U.pushUnique(composedMembers, ChartClass)) {
            ...
            chartProto.initAnnotation = function chartInitAnnotation(
              ...
              const Constructor =
                  AnnotationClass.types[userOptions.type] || AnnotationClass,
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/EventEmitter.js"],
      _modules["Core/Utilities.js"],
    ],
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/ControlPoint.js"],
      _modules["Extensions/Annotations/MockPoint.js"],
      _modules["Core/Utilities.js"],
    ],
    function (ControlPoint, MockPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/ControlTarget.js"],
      _modules["Core/Utilities.js"],
    ],
    function (ControlTarget, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
      ...
      class Controllable {
        ...
        attrsFromOptions(options) {
          const map = this.constructor.attrsMap,
            attrs = {},
          ...
          for (key in options) {
            ...
            if (
              ...
              (!styledMode ||
                ["fill", "stroke", "stroke-width"].indexOf(mappedKey) === -1)
            ) {
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/Controllables/Controllable.js"],
      _modules["Extensions/Annotations/Controllables/ControllableDefaults.js"],
      _modules["Core/Globals.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Controllable, ControllableDefaults, H, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/Controllables/Controllable.js"],
      _modules["Extensions/Annotations/Controllables/ControllablePath.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Controllable, ControllablePath, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    function (Controllable, F, MockPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/Controllables/Controllable.js"],
      _modules["Extensions/Annotations/Controllables/ControllableLabel.js"],
    ],
    function (Controllable, ControllableLabel) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/NavigationBindingsUtilities.js"],
      _modules["Core/Utilities.js"],
    ],
    function (NBU, U) {
      /* *
              ...
              function (e, annotation) {
                ...
                if (
                  ...
                  const inverted = this.chart.inverted,
                    x = this.chart.xAxis[mockPointOpts.xAxis].toPixels(
                      mockPointOpts.x
                    ),
                    y = this.chart.yAxis[mockPointOpts.yAxis].toPixels(
                      mockPointOpts.y
                    );
                  distance = Math.max(
                    Math.sqrt(
            ...
            start: function (e) {
              ...
              return this.chart.addAnnotation(
                merge(
                  ...
                  navigation.annotationsOptions,
                  navigation.bindings.ellipseAnnotation.annotationOptions
                )
              );
            },
            steps: [
              function (e, annotation) {
                const target = annotation.shapes[0],
  ...
  _registerModule(
    ...
    [
      _modules["Core/Chart/ChartNavigationComposition.js"],
      _modules["Core/Defaults.js"],
      _modules["Core/FormatUtilities.js"],
      _modules["Core/Globals.js"],
      _modules["Extensions/Annotations/NavigationBindingsDefaults.js"],
      _modules["Extensions/Annotations/NavigationBindingsUtilities.js"],
      _modules["Core/Utilities.js"],
    ],
    function (
      ...
      class NavigationBindings {
        ...
        initEvents() {
          ...
          [].forEach.call(bindingsContainer, (subContainer) => {
            navigation.eventsToUnbind.push(
              addEvent(subContainer, "click", (event) => {
                ...
                if (
                  bindings &&
                  !bindings.button.classList.contains("highcharts-disabled-btn")
                ) {
          ...
          objectEach(options.events || {}, (callback, eventName) => {
            if (isFunction(callback)) {
              navigation.eventsToUnbind.push(
                addEvent(navigation, eventName, callback, { passive: false })
              );
            }
          });
          navigation.eventsToUnbind.push(
        ...
        initUpdate() {
          const navigation = this;
          ChartNavigationComposition.compose(this.chart).navigation.addUpdate(
            (options) => {
        ...
        annotationToFields(annotation) {
          const options = annotation.options,
            ...
            type = pick(
              ...
              options.labels && options.labels[0] && options.labels[0].type,
              "label"
            ),
            nonEditables =
              NavigationBindings.annotationsNonEditable[options.langKey] || [],
            visualOptions = {
  ...
  _registerModule(
    _modules,
    "Shared/BaseForm.js",
    [_modules["Core/Renderer/HTML/AST.js"], _modules["Core/Utilities.js"]],
    function (AST, U) {
      /* *
       *
      ...
      class BaseForm {
        ...
        addCloseButton(className = "highcharts-popup-close") {
          ...
          closeButton.style["background-image"] =
            "url(" +
            (iconsURL.match(/png|svg|jpeg|jpg|gif/gi)
              ? iconsURL
              : iconsURL + "close.svg") +
            ")";
  ...
  _registerModule(
    ...
    function (H, U) {
      ...
      const { createElement, isArray, isObject, objectEach, pick, stableSort } =
        U;
      /* *
       *
       *  Functions
      ...
      function addForm(chart, options, callback, isInit) {
        ...
        lhsCol.appendChild(
          doc.createTextNode(lang[options.langKey] || options.langKey || "")
        );
        // left column
        ...
        this.addButton(
          bottomRow,
          isInit ? lang.addButton || "Add" : lang.saveButton || "Save",
          isInit ? "add" : "save",
          popupDiv,
          callback
        );
      ...
      function addFormFields(
        ...
        objectEach(options, (value, option) => {
          ...
          parentFullName =
            parentNode !== "" ? parentNode + "." + option : option;
          if (isObject(value)) {
            if (
              ...
              if (!titleName.match(/\d/g)) {
                storage.push([true, titleName, parentDiv]);
              }
              addFormFields.call(
                this,
                parentDiv,
          ...
          storage.forEach((genInput) => {
            if (genInput[0] === true) {
              createElement(
                ...
                void 0,
                genInput[2]
              ).appendChild(doc.createTextNode(genInput[1]));
            } else {
              genInput[4] = {
                value: genInput[4][0],
                type: genInput[4][1],
  ...
  _registerModule(
    ...
    function (AST, H, NU, SeriesRegistry, U) {
      /* *
       *
       *  Popup generator for Stock tools
       *
      ...
      (function (DropdownProperties) {
        DropdownProperties[(DropdownProperties["params.algorithm"] = 0)] =
          "params.algorithm";
        DropdownProperties[(DropdownProperties["params.average"] = 1)] =
          "params.average";
      ...
      function addForm(chart, _options, callback) {
        ...
        const tabsContainers = this.container.querySelectorAll(
        ...
        buttonParentDiv = tabsContainers[0].querySelectorAll(
        ...
        buttonParentDiv = tabsContainers[1].querySelectorAll(
          ".highcharts-popup-rhs-col"
        )[0];
        this.addButton(
          buttonParentDiv,
      ...
      function addIndicatorList(chart, parentDiv, listType, filter) {
        const popup = this,
          lang = popup.lang,
          lhsCol = parentDiv.querySelectorAll(".highcharts-popup-lhs-col")[0],
          rhsCol = parentDiv.querySelectorAll(".highcharts-popup-rhs-col")[0],
            ...
            addEvent(item, eventName, function () {
              ...
              if (isEdit && series.options) {
                createElement(
                  ...
                  void 0,
                  rhsColWrapper
                ).setAttribute("highcharts-data-series-id", series.options.id);
              }
            });
          });
        });
      ...
      function addSelection(indicatorType, optionName, parentDiv) {
        ...
        createElement(
          ...
          null,
          parentDiv
        ).appendChild(doc.createTextNode(lang[labelText] || optionName));
        ...
        if (optionName === "series" || optionName === "volume") {
          ...
          chart.series.forEach((series) => {
            const seriesOptions = series.options,
              seriesName =
                seriesOptions.name || seriesOptions.params
                  ? series.name
                  : seriesOptions.id || "";
            if (
      ...
      function filterSeries(series, filter) {
        ...
        objectEach(series, (series, value) => {
          ...
          if (series.params || (seriesOptions && seriesOptions.params)) {
            const { indicatorFullName, indicatorType } = getNameType(
              series,
              value
            );
            if (filter) {
    ...
    function (H, U) {
      ...
      function deselectAll() {
        const popupDiv = this.container,
          ...
          tabsContent = popupDiv.querySelectorAll(
            ".highcharts-tab-item-content"
          );
      ...
      function selectTab(tab, index) {
        const allTabs = this.container.querySelectorAll(
          ".highcharts-tab-item-content"
        );
  ...
  _registerModule(
    ...
    [
      _modules["Shared/BaseForm.js"],
      _modules["Core/Globals.js"],
      _modules["Core/Defaults.js"],
      _modules["Extensions/Annotations/Popup/PopupAnnotations.js"],
      _modules["Extensions/Annotations/Popup/PopupIndicators.js"],
      _modules["Extensions/Annotations/Popup/PopupTabs.js"],
      _modules["Core/Utilities.js"],
    ],
    function (BaseForm, H, D, PopupAnnotations, PopupIndicators, PopupTabs, U) {
      /* *
       *
       *  Popup generator for Stock tools
       *
      ...
      function getFields(parentDiv, type) {
        ...
        if (volumeTo) {
          fieldsOutput.fields["params.volumeSeriesID"] =
            volumeTo.getAttribute("value") || "";
        }
        return fieldsOutput;
      }
      /* *
        ...
        addInput(option, indicatorType, parentDiv, inputAttributes) {
          const optionParamList = option.split("."),
            ...
            inputName =
              ...
              indicatorType +
              "-" +
              pick(inputAttributes.htmlFor, optionName);
          if (!optionName.match(/^\d+$/)) {
            ...
            createElement(
              ...
              void 0,
              parentDiv
            ).appendChild(doc.createTextNode(lang[optionName] || optionName));
          }
          // add input
        ...
        closeButtonEvents() {
          if (this.chart) {
            ...
            if (
              ...
              fireEvent(navigationBindings, "deselectButton", {
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/Popup/Popup.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Popup, U) {
      /* *
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Extensions/Annotations/AnnotationChart.js"],
      _modules["Extensions/Annotations/AnnotationDefaults.js"],
      _modules["Extensions/Annotations/Controllables/ControllableRect.js"],
      _modules["Extensions/Annotations/Controllables/ControllableCircle.js"],
      _modules["Extensions/Annotations/Controllables/ControllableEllipse.js"],
      _modules["Extensions/Annotations/Controllables/ControllablePath.js"],
      _modules["Extensions/Annotations/Controllables/ControllableImage.js"],
      _modules["Extensions/Annotations/Controllables/ControllableLabel.js"],
      _modules["Extensions/Annotations/ControlPoint.js"],
      _modules["Extensions/Annotations/ControlTarget.js"],
      _modules["Extensions/Annotations/EventEmitter.js"],
      _modules["Extensions/Annotations/MockPoint.js"],
      _modules["Extensions/Annotations/NavigationBindings.js"],
      _modules["Extensions/Annotations/Popup/PopupComposition.js"],
      _modules["Core/Utilities.js"],
    ],
    function (
      A,
      ...
      const { destroyObjectProperties, erase, fireEvent, merge, pick, splat } =
        U;
      /* *
       *
       *  Functions
      ...
      function adjustVisibility(item) {
        const label = item.graphic,
          hasVisiblePoints = item.points.some(
            (point) => point.series.visible !== false && point.visible !== false
          );
        if (label) {
          if (!hasVisiblePoints) {
            label.hide();
      ...
      function getLabelsAndShapesOptions(baseOptions, newOptions) {
        ...
        ["labels", "shapes"].forEach((name) => {
          ...
          if (someBaseOptions) {
            if (newOptions[name]) {
              mergedOptions[name] = splat(newOptions[name]).map(function (
                basicOptions,
                i
              ) {
      ...
      class Annotation extends EventEmitter {
        ...
        initLabel(labelOptions, index) {
          const options = merge(
            ...
            label = new ControllableLabel(this, options, index);
        ...
        renderItem(item) {
          item.render(
            item.itemType === "label" ? this.labelsGroup : this.shapesGroup
          );
        }
        /**
         * @private
       ...
       * @type {Array<string>}
       */
      Annotation.prototype.nonDOMEvents = [
        "add",
        "afterUpdate",
        "drag",
        "remove",
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/Annotation.js"],
      _modules["Extensions/Annotations/MockPoint.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Annotation, MockPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
        ...
        rectangle: [
          {
            positioner: function (annotation) {
              const xy = MockPoint.pointToPixels(annotation.points[2]);
              return {
                x: xy.x - 4,
                y: xy.y - 4,
              };
        ...
        circle: [
          {
            positioner: function (target) {
              const xy = MockPoint.pointToPixels(target.points[0]),
                r = target.options.r;
              return {
                x: xy.x + r * Math.cos(Math.PI / 4) - this.graphic.width / 2,
                y: xy.y + r * Math.sin(Math.PI / 4) - this.graphic.height / 2,
              };
            },
            events: {
  ...
  _registerModule(
    ...
    function (Annotation, ControlPoint, MockPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/Annotation.js"],
      _modules["Extensions/Annotations/Types/CrookedLine.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Annotation, CrookedLine, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    function (Annotation, ControlPoint, CrookedLine, MockPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    function (Annotation, CrookedLine, MockPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    function (Annotation, CrookedLine, ControlPoint, U) {
      /* *
       *
      ...
      class TimeCycles extends CrookedLine {
        ...
        getPath() {
          return [getStartingPath(this.startX, this.y)].concat(
            getCirclePath(
              this.pixelInterval,
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Annotations/Annotation.js"],
      _modules["Extensions/Annotations/MockPoint.js"],
      _modules["Extensions/Annotations/Types/Tunnel.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Annotation, MockPoint, Tunnel, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
      ...
      class Fibonacci extends Tunnel {
        ...
        linkRetracementsPoints() {
          ...
          Fibonacci.levels.forEach((level, i) => {
            const startRetracement = points[0].y - startDiff * level,
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Extensions/Annotations/ControlPoint.js"],
      _modules["Extensions/Annotations/Types/CrookedLine.js"],
      _modules["Extensions/Annotations/Types/InfinityLine.js"],
      _modules["Extensions/Annotations/MockPoint.js"],
      _modules["Core/Utilities.js"],
    ],
    function (
      ...
      function edgePoint(startIndex, endIndex, fibonacciIndex) {
        return function (target) {
          ...
          const xAxis = points[0].series.xAxis,
            ...
            deltaX = points.length > 1 ? points[1].plotX - points[0].plotX : 0,
  ...
  _registerModule(
    ...
    function (Annotation, InfinityLine, MockPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
      ...
      class Pitchfork extends InfinityLine {
        ...
        addLines() {
          this.initShape(
            {
              type: "path",
              points: [this.points[0], Pitchfork.middleLineEdgePoint],
            },
            0
          );
          this.initShape(
            {
              type: "path",
              points: [this.points[1], Pitchfork.topLineEdgePoint],
            },
            1
          );
          this.initShape(
            {
              type: "path",
              points: [this.points[2], Pitchfork.bottomLineEdgePoint],
            },
            2
          );
        }
        addBackgrounds() {
          const shapes = this.shapes,
            typeOptions = this.options.typeOptions;
          const innerBackground = this.initShape(
          ...
          const outerBackground = this.initShape(
  ...
  _registerModule(
    ...
    function (Annotation, ControlPoint, U) {
      /* *
       *
       *  !!!!!!! SOURCE GETS TRANSPILED BY TYPESCRIPT. EDIT TS FILE ONLY. !!!!!!!
       *
  ...
  _registerModule(
    ...
    function (Highcharts, Annotation) {
      const G = Highcharts;
