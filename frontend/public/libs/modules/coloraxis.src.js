...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/color-axis", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
    ...
    function (Color, U) {
      ...
      (function (ColorAxisComposition) {
        ...
        function wrapFxFillSetter() {
          this.elem.attr(
            "fill",
            color(this.start).tweenTo(color(this.end), this.pos),
            void 0,
            true
          );
        }
  ...
  _registerModule(
    _modules,
    "Core/Axis/Color/ColorAxisDefaults.js",
    [],
    function () {
      /* *
       *
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Core/Axis/Color/ColorAxisComposition.js"],
      _modules["Core/Axis/Color/ColorAxisDefaults.js"],
    ...
    function (
      ...
      class ColorAxis extends Axis {
        ...
        drawLegendSymbol(legend, item) {
          ...
          if (!legendItem.symbol) {
            legendItem.symbol = this.chart.renderer
              .symbol("roundedRect", 0, legend.baseline - 11, width, height, {
                r:
                  (_a = legendOptions.symbolRadius) !== null && _a !== void 0
                    ? _a
                    : 3,
              })
              .attr({
          ...
          legendItem.labelHeight =
            height + padding + (horiz ? labelPadding : 0);
        }
        /**
         * Fool the legend.
         * @private
        ...
        getSeriesExtremes() {
          ...
          while (i--) {
            ...
            calculatedExtremes =
              cSeries[colorKey + "Min"] && cSeries[colorKey + "Max"];
        ...
        drawCrosshair(e, point) {
          ...
          if (point) {
            crossPos = axis.toPixels(
              point.getNestedProperty(point.series.colorKey)
            );
            if (crossPos < axisPos) {
              crossPos = axisPos - 2;
        ...
        getDataClassLegendSymbols() {
          const axis = this,
            chart = axis.chart,
            legendItems = (axis.legendItem && axis.legendItem.labels) || [],
            legendOptions = chart.options.legend,
            valueDecimals = pick(legendOptions.valueDecimals, -1),
            valueSuffix = pick(legendOptions.valueSuffix, "");
          const getPointsInDataClass = (i) =>
            axis.series.reduce((points, s) => {
       ...
       * @private
       */
      ColorAxis.keepProps = ["legendItem"];
      /* *
       *
       *  Registry
       *
  ...
  _registerModule(
    ...
    [_modules["Core/Globals.js"], _modules["Core/Axis/Color/ColorAxis.js"]],
    function (Highcharts, ColorAxis) {
      const G = Highcharts;
