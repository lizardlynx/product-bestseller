...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/drilldown", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
  ...
  _registerModule(
    _modules,
    "Extensions/Breadcrumbs/BreadcrumbsDefaults.js",
    [],
    function () {
      /* *
       *
  ...
  _registerModule(
    ...
    [
      _modules["Extensions/Breadcrumbs/BreadcrumbsDefaults.js"],
      _modules["Core/Chart/Chart.js"],
      _modules["Core/FormatUtilities.js"],
      _modules["Core/Utilities.js"],
    ],
    function (BreadcrumbsDefaults, Chart, F, U) {
      /* *
       *
       *  Highcharts Breadcrumbs module
       *
      ...
      class Breadcrumbs {
        ...
        getButtonText(breadcrumb) {
          ...
          let returnText =
            (breadcrumbsOptions.formatter &&
              breadcrumbsOptions.formatter(breadcrumb)) ||
            format(textFormat, { level: breadcrumb.levelOptions }, chart) ||
            "";
          if (
            ((isString(returnText) && !returnText.length) ||
              returnText === "← ") &&
            defined(defaultText)
          ) {
          ...
          const button = chart.renderer
            .button(
              ...
              function (e) {
                ...
                const buttonEvents =
                  breadcrumbsOptions.events && breadcrumbsOptions.events.click;
          ...
          for (let i = 0, iEnd = list.length; i < iEnd; ++i) {
            ...
            if (elementList[breadcrumb.level]) {
              ...
              if (!currentBreadcrumb.separator && !isLast) {
                ...
                currentBreadcrumb.separator = breadcrumbs.renderSeparator(
                  posX,
                  posY
                );
                if (rtl) {
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Series/Column/ColumnSeries.js"],
      ...
      _modules["Core/Utilities.js"],
      _modules["Extensions/Breadcrumbs/Breadcrumbs.js"],
    ],
    function (
      A,
      Axis,
          ...
          if (
            ...
            if (typeof animOptions !== "boolean") {
              const userComplete = animOptions.complete,
                drilldownComplete = function (obj) {
        ...
        level = extend(
          {
            ...
            resetZoomButton:
              last && last.levelNumber === levelNumber
                ? void 0
      ...
      Chart.prototype.drillUp = function (isMultipleDrillUp) {
        ...
        const chart = this,
          ...
          addSeries = function (seriesOptions, oldSeries) {
            let addedSeries;
        ...
        while (i--) {
          ...
          if (level.levelNumber === levelNumber) {
            ...
            if (!oldSeries.chart) {
              ...
              while (seriesI--) {
                if (
                  ...
                  chartSeries[seriesI].options._levelNumber === levelNumber + 1
                ) {
                  // #3867
            ...
            if (!this.mapView) {
              ...
              const shouldAnimate =
                  level.levelNumber === levelNumber && isMultipleDrillUp,
                zoomingDrill =
                  chart.options.drilldown &&
                  chart.options.drilldown.animation &&
                  chart.options.drilldown.mapZooming;
      ...
      addEvent(Point, "afterInit", function () {
        ...
        if (point.drilldown && !point.unbindDrilldownClick) {
          ...
          point.unbindDrilldownClick = addEvent(
            point,
            "click",
            handlePointClick
          );
      ...
      addEvent(Series, "afterDrawDataLabels", function () {
        const css = this.chart.options.drilldown.activeDataLabelStyle,
  ...
  _registerModule(
    ...
    function (Highcharts, Breadcrumbs) {
      const G = Highcharts;
