...
(function (b) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/modules/annotations", ["highcharts"], function (r) {
        b(r);
        b.Highcharts = r;
        return b;
      })
  ...
  r(
    ...
    function (b) {
      ...
      function h() {
        ...
        c(a, "exportData", function (c) {
            ...
            a.options.labelOptions &&
              ...
              a.labels.forEach((a) => {
                if (a.options.text) {
                  ...
                  a.points.forEach((a) => {
                    const k = a.x,
                      f = a.series.xAxis ? a.series.xAxis.options.index : -1;
                    let m = !1;
                    if (-1 === f) {
          ...
          for (let a = 0; a < D; a++) {
            const d = b(a + 1);
            f
              ? (c.dataRows[0].push(d.topLevelColumnTitle),
                c.dataRows[1].push(d.columnTitle))
              : c.dataRows[0].push(d);
          }
        });
      }
      ...
      function e(a) {
        ...
        d &&
          (q(d, "remove"),
          u(this.options.annotations, d.options),
          u(c, d),
          d.destroy());
      }
      function d() {
      ...
      class p {
        addEvents() {
          ...
          a(c.options.events, (a, d) => {
            const f = function (f) {
              ("click" === d && c.cancelClick) ||
                a.call(c, c.chart.pointer.normalize(f), c.target);
            };
          ...
          if (
            c.options.draggable &&
            (e(c, "drag", c.onDrag), !c.graphic.renderer.styledMode)
          ) {
            const a = {
        ...
        onDrag(a) {
          if (
            ...
            this.points.length
              ...
              : (this.shapes.forEach((a) => a.translate(c.x, c.y)),
                this.labels.forEach((a) => a.translate(c.x, c.y)));
            this.redraw(!1);
          }
        }
        onMouseDown(a) {
  ...
  r(
    ...
    [b["Extensions/Annotations/EventEmitter.js"], b["Core/Utilities.js"]],
    function (b, n) {
      ...
      class e extends b {
        ...
        render() {
          const d = this.chart,
            a = this.options;
          this.graphic = d.renderer
            .symbol(a.symbol, 0, 0, a.width, a.height)
            .add(d.controlPointsGroup)
            .css(a.style);
  ...
  r(
    ...
    function (b, n) {
      ...
      class d {
        static fromPoint(a) {
          return new d(a.series.chart, null, {
            x: a.x,
            y: a.y,
        ...
        static pointToPixels(a, c) {
          ...
          b.inverted &&
            (a.mock
              ? ((e = a.plotY), (f = a.plotX))
              : ((e = b.plotWidth - (a.plotY || 0)),
                (f = b.plotHeight - (a.plotX || 0))));
          d &&
            !c &&
            ((a = d.getPlotBox()), (e += a.translateX), (f += a.translateY));
          return { x: e, y: f };
        }
        ...
        isInsidePlot() {
          ...
          b &&
            (h.isInsidePlot = h.isInsidePlot && g(c) && 0 <= c && c <= b.len);
        ...
        refresh() {
          ...
          c
            ? ((this.x = d.x), (this.plotX = c.toPixels(d.x, !0)))
            : ((this.x = void 0), (this.plotX = d.x));
          a
            ? ((this.y = d.y), (this.plotY = a.toPixels(d.y, !0)))
            : ((this.y = null), (this.plotY = d.y));
        ...
        refreshOptions() {
          ...
          const c = a.xAxis;
          a = a.yAxis;
          this.x = this.options.x = c
            ? (this.options.x = c.toValue(this.plotX, !0))
            : this.plotX;
        ...
        setAxis(a, c) {
          ...
          this.series[c] =
            "object" === typeof a ? a : g(a) ? d[c][a] || d.get(a) : null;
        }
        toAnchor() {
        ...
        translate(a, c, d, b) {
          this.hasDynamicOptions() ||
            ((this.plotX += d), (this.plotY += b), this.refreshOptions());
        }
      }
      ("");
      return d;
      ...
      (function (e) {
        ...
        function a(a) {
          ...
          var b = a.mock
            ? a.toAnchor()
            : (d.tooltip &&
                d.tooltip.getAnchor.call({ chart: a.series.chart }, a)) || [
                0, 0, 0, 0,
              ];
          b = {
          ...
          return {
            relativePosition: b,
            absolutePosition: h.merge(b, {
              x: b.x + (a.mock ? c.translateX : d.plotLeft),
              y: b.y + (a.mock ? c.translateY : d.plotTop),
            }),
          };
        }
        function c() {
        ...
        function q(a, c) {
          ...
          (c && null !== c.series) ||
            (h.isObject(a)
              ? (c = new n(this.chart, this, a))
              : h.isString(a)
              ? (c = this.chart.get(a) || null)
              : "function" === typeof a &&
                ((c = a.call(c, this)),
                (c = c.series ? c : new n(this.chart, this, a))));
          return c;
        }
        function f(a) {
        ...
        function D(a, c, d, b, f) {
          ...
          this.points.forEach(
            (m, l) => this.transformPoint(a, c, d, b, f, l),
            this
          );
        }
  ...
  r(
    ...
    [b["Extensions/Annotations/ControlTarget.js"], b["Core/Utilities.js"]],
    function (b, n) {
      const { merge: h } = n;
      class g {
        constructor(b, d, a, c) {
          ...
          for (e in b)
            (g = d[e]),
              "undefined" === typeof d[e] ||
                (c && -1 !== ["fill", "stroke", "stroke-width"].indexOf(g)) ||
                (a[g] = b[e]);
          return a;
        }
        destroy() {
  ...
  r(
    ...
    [
      b["Extensions/Annotations/Controllables/Controllable.js"],
      b["Extensions/Annotations/Controllables/ControllableDefaults.js"],
      b["Core/Globals.js"],
      b["Core/Utilities.js"],
    ],
    function (b, n, h, g) {
        ...
        toD() {
          ...
          if (m)
            for (d.push(["M", m.x, m.y]); ++e < c && b; )
              (f = a[e]),
                (b = f.command || "L"),
                (m = this.anchor(f).absolutePosition),
                "M" === b
                  ? d.push([b, m.x, m.y])
                  : "L" === b
                  ? d.push([b, m.x, m.y])
        ...
        redraw(a) {
          if (this.graphic) {
            const c = this.toD(),
              d = a ? "animate" : "attr";
            c
              ? (this.graphic[d]({ d: c }), this.tracker[d]({ d: c }))
          ...
          ["markerStart", "markerEnd"].forEach(function (e) {
            ...
            if (l) {
              for (z in b)
                if (
                  ((k = b[z]),
                  (l === (k.attributes && k.attributes.id) || l === k.id) &&
                    "marker" === k.tagName)
                ) {
                  t = k;
                  break;
              ...
              t &&
                ((l = a[e] =
                  d.renderer.addMarker(
                    (c.id || m()) + "-" + l,
                    f(t, { color: g })
                  )),
                a.attr(e, l.getAttribute("id")));
            }
          });
        }
      }
    ...
    function (b, n, h) {
      ...
      class d extends b {
        ...
        getDistanceFromLine(a, c, d, b) {
          return (
            Math.abs(
              (c.y - a.y) * d - (c.x - a.x) * b + c.x * a.y - c.y * a.x
            ) / Math.sqrt((c.y - a.y) * (c.y - a.y) + (c.x - a.x) * (c.x - a.x))
          );
        }
        getAttrs(a, c) {
          var d = a.x,
          ...
          if (this.graphic) {
            ...
            if (d)
              this.graphic[a ? "animate" : "attr"]({
                ...
                ry: c.ry,
                rotation: c.angle,
                rotationOriginX: c.cx,
                rotationOriginY: c.cy,
              });
            else this.graphic.attr({ x: 0, y: -9e9 });
            this.graphic.placed = !!d;
          }
    ...
    function (b, n, h, g) {
      ...
      class q extends b {
        ...
        static justifiedOptions(a, c, d, b) {
          ...
          h = d + g;
          0 > h &&
            ("right" === f ? (c.align = "left") : (c.x = (c.x || 0) - h));
          h = d + e.width - g;
          h > a.plotWidth &&
            ("left" === f
              ? (c.align = "right")
              : (c.x = (c.x || 0) + a.plotWidth - h));
          h = b + g;
          0 > h &&
            ("bottom" === m
              ? (c.verticalAlign = "top")
        ...
        render(a) {
          ...
          this.annotation.chart.styledMode ||
            ("contrast" === b.color &&
              (b.color = this.annotation.chart.renderer.getContrast(
                -1 < q.shapesWithoutBackground.indexOf(c.shape)
                  ? "#FFFFFF"
                  : c.backgroundColor
              )),
            this.graphic.css(c.style).shadow(c.shadow));
          c.className && this.graphic.addClass(c.className);
        ...
        redraw(a) {
          ...
          f
            ? (f.attr({
                text: b
                  ? d(String(b), g.getLabelConfig(), this.annotation.chart)
                  : c.formatter.call(g, this),
              }),
              (c = this.anchor(g)),
              (b = this.position(c))
                ? ((f.alignAttr = b),
                  (b.anchorX = c.absolutePosition.x),
                  (b.anchorY = c.absolutePosition.y),
                  f[a ? "animate" : "attr"](b))
                : f.attr({ x: 0, y: -9999 }),
              (f.placed = !!b),
              super.redraw(a))
        ...
        position(c) {
          ...
          if (d && c) {
            ...
            e.distance && f
              ? (p = f.getPosition.call(
                  {
                    chart: b,
                    distance: u(e.distance, 16),
              ...
              : ((f = { x: n.x, y: n.y, width: 0, height: 0 }),
                (p = q.alignedPosition(a(e, { width: h, height: m }), f)),
                "justify" === this.options.overflow &&
                  (p = q.alignedPosition(q.justifiedOptions(b, d, e, p), f)));
            e.crop &&
              ((d = p.x - b.plotLeft),
              (e = p.y - b.plotTop),
              (c = b.isInsidePlot(d, e) && b.isInsidePlot(d + h, e + m)));
          }
          return c ? p : null;
        }
      }
      ...
      class h extends b {
        ...
        render(b) {
          const e = this.attrsFromOptions(this.options),
            d = this.options;
          this.graphic = this.annotation.chart.renderer
            .image(d.src, 0, -9e9, d.width, d.height)
            .attr(e)
            .add(b);
        ...
        redraw(b) {
          if (this.graphic) {
            ...
            if ((e = n.prototype.position.call(this, e)))
              this.graphic[b ? "animate" : "attr"]({ x: e.x, y: e.y });
            else this.graphic.attr({ x: 0, y: -9e9 });
              ...
              steps: [
                function (b, a) {
                  ...
                  if (g(c.xAxis) && g(c.yAxis)) {
                    ...
                    d = Math.max(
                      Math.sqrt(
                        Math.pow(d ? c - b.chartX : a - b.chartX, 2) +
                          Math.pow(d ? a - b.chartY : c - b.chartY, 2)
                      ),
                      5
                    );
                  }
    ...
    function (b, n, h, g, e, d, a) {
                ...
                for (let b = 0; b < d.length; b++) {
                  ...
                  "normal" === a.noDataState
                    ? -1 !== f.indexOf("highcharts-disabled-btn") &&
                      k.classList.remove("highcharts-disabled-btn")
                    : c
                    ? -1 !== f.indexOf("highcharts-disabled-btn") &&
                      k.classList.remove("highcharts-disabled-btn")
                    : -1 === f.indexOf("highcharts-disabled-btn") &&
                      (k.className += " highcharts-disabled-btn");
                }
            });
          }
        }
              ...
              y(d, "showPopup", {
                ...
                onSubmit: function (a) {
                  if ("remove" === a.actionType)
                    (d.activeAnnotation = !1), d.chart.removeAnnotation(b);
                  else {
                    const c = {};
        ...
        t(!0, a.prototype.defaultOptions.events, {
          ...
          touchend: function (a) {
            (d &&
              4 <=
                Math.sqrt(
                  Math.pow(d - a.changedTouches[0].clientX, 2) +
                    Math.pow(k - a.changedTouches[0].clientY, 2)
                )) ||
              b.call(this, a);
          },
        });
      ...
      class F {
        static compose(b, c) {
          ...
          a.pushUnique(J, c) &&
            (x(c, "destroy", p), x(c, "load", q), x(c, "render", f));
          a.pushUnique(J, F) &&
            (x(F, "closePopup", m), x(F, "deselectButton", D));
        ...
        constructor(a, b) {
          ...
          this.container.length ||
            (this.container = C.getElementsByClassName(
              this.options.bindingsClassName || ""
            ));
        }
        initEvents() {
            ...
            a.eventsToUnbind.push(
              x(b, "click", (c) => {
                ...
                d &&
                  ...
                  a.bindingsButtonClick(d.button, d.events, c);
              })
            );
          });
          z(d.events || {}, (b, c) => {
        ...
        bindingsButtonClick(a, b, c) {
          ...
          this.selectedButtonElement &&
            ...
            this.nextEvent &&
              (this.currentUserDetails &&
                ...
                d.removeAnnotation(this.currentUserDetails),
          ...
          f
            ? ((this.selectedButton = b),
              ...
              (b.start || b.steps) &&
                d.renderer.boxWrapper.addClass("highcharts-draw-mode"))
            : (d.stockTools && d.stockTools.toggleButtonActiveClass(a),
              k.removeClass("highcharts-draw-mode"),
              (this.mouseMoveEvent = this.nextEvent = !1),
        ...
        fieldsToOptions(a, b) {
          z(a, (a, c) => {
            const d = parseFloat(a),
              k = c.split("."),
              f = k.length - 1;
            !B(d) || a.match(/px/g) || c.match(/format/g) || (a = d);
            if ("undefined" !== a) {
              let c = b;
              k.forEach((b, d) => {
                const t = G(k[d + 1], "");
        ...
        getButtonEvents(a, b) {
          ...
          this.getClickedClassNames(a, b).forEach((a) => {
            c.boundClassNames[a[0]] &&
              !d &&
              (d = { events: c.boundClassNames[a[0]], button: a[1] });
          });
          return d;
        }
        update(a) {
  ...
  r(
    b,
    "Shared/BaseForm.js",
    [b["Core/Renderer/HTML/AST.js"], b["Core/Utilities.js"]],
    function (b, n) {
      ...
      class e {
        ...
        createPopupContainer(b, a = "highcharts-popup highcharts-no-tooltip") {
          return g("div", { className: a }, void 0, b);
        }
        addCloseButton(b = "highcharts-popup-close") {
          const a = this,
            c = this.iconsURL,
            d = g("div", { className: b }, void 0, this.container);
          d.style["background-image"] =
            "url(" +
            (c.match(/png|svg|jpeg|jpg|gif/gi) ? c : c + "close.svg") +
            ")";
        ...
        showPopup(d = "highcharts-annotation-toolbar") {
          const a = this.container,
            c = this.closeButton;
          this.type = void 0;
          a.innerHTML = b.emptyHTML;
          0 <= a.className.indexOf(d) &&
            (a.classList.remove(d), a.removeAttribute("style"));
          a.appendChild(c);
        ...
        if (m) {
          ...
          u(p, (d, f) => {
            ...
            c(d) &&
              (!a(d) || (a(d) && c(d[0]))
                ? ((x = l[f] || f),
                  x.match(/\d/g) || v.push([!0, x, b]),
                  h.call(this, b, m, w, d, v, !1))
                : v.push([this, w, "annotation", b, d]));
          });
          E &&
      ...
      return {
        addForm: function (a, b, c, e) {
          if (a) {
            ...
            this.addButton(
              l,
              e ? m.addButton || "Add" : m.saveButton || "Save",
              e ? "add" : "save",
              f,
              c
            );
        ...
        addToolbar: function (a, b, c) {
          const f = this.lang,
            e = this.container,
            h = this.showForm;
          -1 === e.className.indexOf("highcharts-annotation-toolbar") &&
            (e.className += " highcharts-annotation-toolbar");
          a && (e.style.top = a.plotTop + 10 + "px");
          d("span", void 0, void 0, e).appendChild(
            g.createTextNode(
              p(f[b.langKey] || b.langKey, b.shapes && b.shapes[0].type, "")
            )
          );
  ...
  r(
    ...
    function (b, n, h, g, e) {
      ...
      function a(a, d, e, g) {
        const k = this,
          t = k.lang,
          h = d.querySelectorAll(".highcharts-popup-lhs-col")[0];
        ...
        if (a || !e) {
          ...
          var q = l(
            ...
            p = d.querySelectorAll(".highcharts-popup-rhs-col-wrapper")[0];
          G.forEach((d) => {
            const { indicatorFullName: f, indicatorType: e, series: t } = d;
            n = l("li", { className: "highcharts-indicator-list" }, void 0, q);
              ...
              C(n, d, function () {
                const d = p.parentNode.children[1];
                {
                  ...
                  l(
                    ...
                    void 0,
                    p
                  ).appendChild(v.createTextNode(r(t, e).indicatorFullName));
                  l(
                    "input",
                  ...
                  A.call(
                    ...
                    p,
                    t,
                    t.linkedParent && t.linkedParent.options.id
                  );
                  d.volumeSeriesID &&
                    A.call(
                      k,
                      ...
                      p,
                      t,
                      t.linkedParent && d.volumeSeriesID
                    );
                ...
                z &&
                  ...
                  l(
                    ...
                    void 0,
                    p
                  ).setAttribute("highcharts-data-series-id", t.options.id);
              });
            });
          });
          0 < q.childNodes.length
            ? q.childNodes[0].click()
            : z ||
              (b.setElementHTML(
                p.parentNode.children[0],
                t.noFilterMatch || ""
              ),
              (p.parentNode.children[1].style.display = "none"));
        }
      }
        ...
        if (a) {
          ...
          y(d, (d, t) => {
            ...
            w(d) &&
              ...
              g in I
                ? ((g = p.call(this, f, g, e)), q.call(this, a, b, g, f, t, d))
                : "params.volumeSeriesID" === g ||
                  x(d) ||
                  k.call(this, g, f, e, { value: d, type: "number" }));
          });
        }
      }
      function u(b, c) {
        const d = this;
        var k = c.querySelectorAll(".highcharts-popup-lhs-col")[0];
        c = this.lang.clearFilter;
        k = l("div", { className: "highcharts-input-wrapper" }, void 0, k);
        const f = this.addInput("searchIndicators", "input", k, {
            value: "",
            type: "text",
        ...
        "series" === b || "volume" === b
          ? a.series.forEach((a) => {
              ...
              "highcharts-navigator-series" !== d.id &&
                ...
                (w(e) || "volume" !== b || "column" !== a.type || (e = d.id),
                l("option", { value: d.id }, void 0, c).appendChild(
                  v.createTextNode(k)
                ));
            })
          : d &&
          ...
          if (a.params || (e && e.params)) {
            ...
            if (b) {
              if (
                ...
                (f = { indicatorFullName: g, indicatorType: t, series: a }),
                  k.push(f);
            } else
              (f = { indicatorFullName: g, indicatorType: t, series: a }),
                k.push(f);
      ...
      function A(a, b, c, d, f, e) {
        c &&
          ((a = p.call(this, a, b, d)),
          q.call(this, c, b, a, void 0, void 0, void 0, f),
          w(e) && (a.value = e));
      }
      const { doc: v } = n,
        { seriesTypes: E } = g,
      ...
      return {
        addForm: function (b, c, f) {
          ...
          if (b) {
            ...
            k = e[0].querySelectorAll(".highcharts-popup-rhs-col")[0];
            this.addButton(k, c.addButton || "add", "add", k, f);
            d(e[1]);
            a.call(this, b, e[1], "edit");
            k = e[1].querySelectorAll(".highcharts-popup-rhs-col")[0];
    ...
    function (b, n) {
      ...
      function g(b, c) {
        const d = this.container,
          e = this.lang;
        let g = "highcharts-tab-item";
        0 === c && (g += " highcharts-tab-disabled");
      ...
      function d(a) {
        ...
        this.container
          ...
          .forEach((d, g) => {
            (0 === a &&
              "edit" === d.getAttribute("highcharts-data-tab-type")) ||
              ["click", "touchstart"].forEach((a) => {
                c(d, a, function () {
                  {
                    var a = b.container;
                    const c = a.querySelectorAll(".highcharts-tab-item");
                    a = a.querySelectorAll(".highcharts-tab-item-content");
                    for (let b = 0; b < c.length; b++)
                      c[b].classList.remove("highcharts-tab-item-active"),
                        a[b].classList.remove("highcharts-tab-item-show");
                  }
                  e.call(b, this, g);
                });
              });
  ...
  r(
    ...
    function (b, n, h, g, e, d, a) {
      function c(a, b) {
        ...
        const f = {
          actionType: b,
          linkedTo: (e && e.getAttribute("value")) || "",
          fields: {},
        };
        c.forEach((a) => {
      ...
      class v extends b {
        ...
        addInput(a, b, c, d) {
          ...
          e = e[e.length - 1];
          const g = this.lang;
          b = "highcharts-" + b + "-" + A(d.htmlFor, e);
          e.match(/^\d+$/) ||
            f(
              "label",
              { htmlFor: b, className: d.labelClassName },
              void 0,
              c
            ).appendChild(u.createTextNode(g[e] || e));
          c = f(
            "input",
            {
              name: b,
        ...
        closeButtonEvents() {
          if (this.chart) {
            ...
            a &&
              ...
              r(a, "deselectButton", { button: a.selectedButtonElement });
        ...
        showForm(a, b, c, d) {
          b &&
            ...
            "annotation-toolbar" === a &&
              this.annotations.addToolbar.call(this, b, c, d),
            "annotation-edit" === a &&
              this.annotations.addForm.call(this, b, c, d),
  ...
  r(
    ...
    [b["Extensions/Annotations/Popup/Popup.js"], b["Core/Utilities.js"]],
    function (b, n) {
      function h() {
        ...
        redrawItem(a, b) {
          ...
          a.shouldBeDrawn()
            ? (a.graphic || this.renderItem(a),
              a.redraw(L(b, !0) && a.graphic.placed),
              a.points.length && u(a))
            : this.destroyItem(a);
        }
        redrawItems(a, b) {
  ...
  r(
    b,
    "masters/modules/annotations.src.js",
    [b["Core/Globals.js"], b["Extensions/Annotations/Annotation.js"]],
    function (b, n) {
      b.Annotation = n;
