...
(function (factory) {
  if (typeof module === "object" && module.exports) {
    ...
    define("highcharts/modules/accessibility", ["highcharts"], function (
      Highcharts
    ) {
      factory(Highcharts);
  ...
  _registerModule(
    ...
    function (H, U) {
       ...
       *
       * */
      const simulatedEventTarget =
        (win.EventTarget && new win.EventTarget()) || "none";
      /* *
       *
       *  Functions
       *
  ...
  _registerModule(
    ...
    [_modules["Core/FormatUtilities.js"], _modules["Core/Utilities.js"]],
    function (F, U) {
      /* *
       *
      ...
      (function (A11yI18nComposition) {
        ...
        function formatExtendedStatement(statement, ctx) {
          ...
          if (eachStart > -1) {
            ...
            if (arr) {
              ...
              len =
                lenArg < 0 ? arr.length + lenArg : Math.min(lenArg, arr.length); // Overshoot
        ...
        function i18nFormat(formatString, context, chart) {
          ...
          // statements.
          return format(
            tokens.reduce((acc, cur) => acc + cur.value, ""),
            context,
            chart
          );
        }
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Accessibility/Utils/HTMLUtilities.js"],
    ...
    function (H, HU, U) {
      ...
      function getAxisTimeLengthDesc(axis) {
        ...
        const rangeValue = range[rangeUnit].toFixed(
      ...
      function getSeriesA11yElement(series) {
        ...
        return (
          (firstPointEl && firstPointEl.parentNode) ||
  ...
  _registerModule(
    ...
    [
      _modules["Accessibility/Utils/ChartUtilities.js"],
      _modules["Accessibility/Utils/DOMElementProvider.js"],
      _modules["Accessibility/Utils/EventProvider.js"],
      _modules["Accessibility/Utils/HTMLUtilities.js"],
      _modules["Core/Utilities.js"],
    ],
    function (CU, DOMElementProvider, EventProvider, HU, U) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
  ...
  _registerModule(
    ...
    [
      _modules["Accessibility/AccessibilityComponent.js"],
      _modules["Accessibility/KeyboardNavigationHandler.js"],
      _modules["Accessibility/Utils/ChartUtilities.js"],
      _modules["Core/Globals.js"],
      _modules["Accessibility/Utils/HTMLUtilities.js"],
    ],
    function (AccessibilityComponent, KeyboardNavigationHandler, CU, H, HU) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
      ...
      class ContainerComponent extends AccessibilityComponent {
        ...
        setRenderToAttrs() {
          const chart = this.chart,
            shouldHaveLandmark =
              chart.options.accessibility.landmarkVerbosity !== "disabled",
          ...
          if (containerLabel) {
            chart.renderTo.setAttribute(
              "role",
              shouldHaveLandmark ? "region" : "group"
            );
  ...
  _registerModule(
    ...
    [_modules["Core/Renderer/SVG/SVGLabel.js"], _modules["Core/Utilities.js"]],
    function (SVGLabel, U) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
      ...
      (function (FocusBorderComposition) {
        ...
        function svgElementAddFocusBorder(margin, attribs) {
          ...
          const bb = this.getBBox(),
            ...
            scaleBoth = oneDefined
              ? Math.abs(scaleX || scaleY || 1)
  ...
  _registerModule(
    ...
    [
      _modules["Core/Renderer/HTML/AST.js"],
      _modules["Accessibility/Utils/DOMElementProvider.js"],
      _modules["Core/Globals.js"],
      _modules["Accessibility/Utils/HTMLUtilities.js"],
      _modules["Core/Utilities.js"],
    ],
    function (AST, DOMElementProvider, H, HU, U) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
    ...
    function (HTMLUtilities) {
      ...
      function getAnnotationLabelDescription(label) {
        ...
        const getValueDesc = (point) => {
          ...
          return (
            (seriesName ? seriesName + ", " : "") + "data point " + valDesc
          );
        };
      ...
      function getPointAnnotationTexts(point) {
        ...
        const pointLabels = labels.filter(
          (label) => label.points.indexOf(point) > -1
        );
  ...
  _registerModule(
    ...
    [
      _modules["Accessibility/A11yI18n.js"],
      _modules["Accessibility/AccessibilityComponent.js"],
      _modules["Accessibility/Utils/Announcer.js"],
      _modules["Accessibility/Components/AnnotationsA11y.js"],
      _modules["Core/Renderer/HTML/AST.js"],
      _modules["Accessibility/Utils/ChartUtilities.js"],
      _modules["Core/FormatUtilities.js"],
      _modules["Core/Globals.js"],
      _modules["Accessibility/Utils/HTMLUtilities.js"],
      _modules["Core/Utilities.js"],
    ],
    function (
      ...
      function buildTypeDescriptionFromSeries(chart, types, context) {
        const firstType = types[0],
          ...
          multi =
            chart.series && chart.series.length < 2 ? "Single" : "Multiple";
        return (
          (chart.langFormat(
      ...
      function getTypeDescription(chart, types) {
        const firstType = types[0],
          ...
          mapTitle =
            chart.mapView && chart.mapView.geoMap && chart.mapView.geoMap.title,
          formatContext = {
  ...
  _registerModule(
    ...
    [
      _modules["Core/Globals.js"],
      _modules["Accessibility/Components/MenuComponent.js"],
      _modules["Core/Utilities.js"],
      _modules["Accessibility/Utils/EventProvider.js"],
      _modules["Accessibility/Utils/HTMLUtilities.js"],
    ],
    function (H, MenuComponent, U, EventProvider, HTMLUtilities) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
      ...
      class KeyboardNavigation {
        ...
        init(chart, components) {
          ...
          this.update();
          ep.addEvent(this.tabindexContainer, "keydown", (e) =>
            this.onKeydown(e)
          );
          ep.addEvent(this.tabindexContainer, "focus", (e) => this.onFocus(e));
          ["mouseup", "touchend"].forEach((eventName) =>
            ep.addEvent(doc, eventName, (e) => this.onMouseUp(e))
          );
          ["mousedown", "touchstart"].forEach((eventName) =>
            ep.addEvent(chart.renderTo, eventName, () => {
        ...
        update(order) {
          ...
          if (
            ...
            this.modules = order.reduce(function (modules, componentName) {
              const navModules =
                components[componentName].getKeyboardNavigation();
        ...
        onFocus(e) {
          const chart = this.chart,
            focusComesFromChart =
              e.relatedTarget && chart.container.contains(e.relatedTarget),
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Core/Globals.js"],
      _modules["Core/Legend/Legend.js"],
      _modules["Core/Utilities.js"],
      _modules["Accessibility/AccessibilityComponent.js"],
      _modules["Accessibility/KeyboardNavigationHandler.js"],
      _modules["Accessibility/Utils/ChartUtilities.js"],
      ...
      function shouldDoLegendA11y(chart) {
        const items = chart.legend && chart.legend.allItems,
          ...
          unsupportedColorAxis =
            chart.colorAxis &&
            chart.colorAxis.some(
              (c) => !c.dataClasses || !c.dataClasses.length
            );
        return !!(
          items &&
          items.length &&
      ...
      class LegendComponent extends AccessibilityComponent {
          ...
          this.addEvent(Legend, "afterRender", function () {
            if (
              ...
              syncTimeout(
                ...
                animObject(pick(this.chart.renderer.globalAnimation, true))
                  .duration
              );
            }
          });
            ...
            if (item.a11yProxyElement) {
              ...
              if (hasPages) {
                ...
                const h = legendItem.label
                  ...
                  : 0;
                hide =
                  y + h - legend.pages[itemPage] > clipHeight ||
                  itemPage !== curPage - 1;
              }
              if (hide) {
                if (chart.styledMode) {
        ...
        recreateProxies() {
          ...
          const shouldRestoreFocus =
            focusedElement && proxyGroup && proxyGroup.contains(focusedElement);
          this.removeProxies();
          if (shouldDoLegendA11y(this.chart)) {
        ...
        addLegendProxyGroup() {
          const a11yOptions = this.chart.options.accessibility;
          const groupRole =
            a11yOptions.landmarkVerbosity === "all" ? "region" : null;
        ...
        proxyLegendItem(item) {
          ...
          const proxyPositioningElement = legendItem.group.div
            ? legendItem.label
            : legendItem.group;
          item.a11yProxyElement = this.proxyProvider.addProxyElement(
            "legend",
            {
          ...
          return new KeyboardNavigationHandler(chart, {
            ...
            terminate: function () {
              ...
              chart.legend.allItems.forEach((item) =>
                setLegendItemHoverState(false, item)
              );
            },
          });
        }
  ...
  _registerModule(
    ...
    function (AnnotationsA11y, ChartUtilities, F, HTMLUtilities, U) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
      ...
      function findFirstPointWithGraphic(point) {
        ...
        return (
          find(point.series.data, function (p) {
            return !!(
              p &&
      ...
      function shouldAddMockPoint(point) {
        ...
        const series = point.series,
          ...
          isNull = point.isNull,
          shouldDescribeNull =
            chart && chart.options.accessibility.point.describeNull;
      ...
      function shouldSetKeyboardNavPropsOnPoints(series) {
        const chartA11yOptions = series.chart.options.accessibility,
          seriesNavOptions =
            chartA11yOptions.keyboardNavigation.seriesNavigation;
        return !!(
          series.points &&
      ...
      function shouldDescribeSeriesElement(series) {
        const chart = series.chart,
          ...
          describeSingleSeriesOption =
            chart.options.accessibility.series.describeSingleSeries,
      ...
      function getPointXDescription(point) {
        const timeDesc = getPointA11yTimeDescription(point),
          ...
          canUseId =
            defined(point.id) && ("" + point.id).indexOf("highcharts-") < 0,
          fallback = "x, " + point.x;
        return (
          point.name ||
          timeDesc ||
      ...
      function defaultPointDescriptionFormatter(point) {
        const series = point.series,
          shouldExposeSeriesName =
            series.chart.series.length > 1 || series.options.name,
          ...
          seriesNameText = shouldExposeSeriesName
            ? " " + series.name + "."
            : "",
      ...
      function describePointsInSeries(series) {
        const setScreenReaderProps = shouldSetScreenReaderPropsOnPoints(series),
          ...
          shouldDescribeNullPoints =
            series.chart.options.accessibility.point.describeNull;
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Accessibility/Utils/ChartUtilities.js"],
      _modules["Accessibility/Utils/EventProvider.js"],
      _modules["Accessibility/Components/SeriesComponent/SeriesDescriber.js"],
    ],
    function (H, U, Announcer, ChartUtilities, EventProvider, SeriesDescriber) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
      ...
      function findPointInDataArray(point) {
        const candidates = point.series.data.filter(
          (candidate) => point.x === candidate.x && point.y === candidate.y
        );
          ...
          if (
            ...
            this.queueAnnouncement(
              Object.keys(this.dirty.allSeries).map(
                (ix) => announcer.dirty.allSeries[ix]
              ),
  ...
  _registerModule(
    ...
    function (H, U, EventProvider, ChartUtilities, HTMLUtilities) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
      ...
      class ProxyElement {
        ...
        updateCSSClassName() {
          ...
          const targetClassName =
            this.getTargetAttr(this.target.click, "class") || "";
        ...
        getTargetPosition() {
          ...
          if (chartDiv && posElement && posElement.getBoundingClientRect) {
            ...
            return {
              ...
              width:
                rectEl.right / chartPos.scaleX - rectEl.left / chartPos.scaleX,
              height:
                rectEl.bottom / chartPos.scaleY - rectEl.top / chartPos.scaleY,
            };
          }
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Accessibility/Utils/DOMElementProvider.js"],
      _modules["Accessibility/Utils/HTMLUtilities.js"],
      _modules["Accessibility/ProxyElement.js"],
    ],
    function (H, U, CU, DOMElementProvider, HU, ProxyElement) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
      ...
      class ProxyProvider {
        ...
        addGroup(groupKey, groupType, attributes) {
          ...
          const proxyContainer =
            this.domElementProvider.createElement(groupType);
        ...
        getCurrentGroupOrderInDOM() {
          ...
          const before = getChildrenGroupOrder(
            this.beforeChartProxyPosContainer
          );
  ...
  _registerModule(
    ...
    [
      _modules["Core/Defaults.js"],
      _modules["Stock/RangeSelector/RangeSelectorDefaults.js"],
      _modules["Core/Utilities.js"],
    ],
    function (D, RangeSelectorDefaults, U) {
      /* *
       *
       *  (c) 2010-2021 Torstein Honsi
       *
        ...
        const rangeSelector = chart.rangeSelector,
          redraw = () => {
            if (rangeSelector) {
              ...
              legend = chart.legend;
              verticalAlign =
                rangeSelector && rangeSelector.options.verticalAlign;
      ...
      function onChartUpdate(e) {
        ...
        if (
          ...
          this.rangeSelector = rangeSelector = new RangeSelectorConstructor(
            this
          );
        }
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Core/Defaults.js"],
      _modules["Core/Globals.js"],
      _modules["Stock/RangeSelector/RangeSelectorComposition.js"],
      _modules["Core/Renderer/SVG/SVGElement.js"],
      _modules["Core/Utilities.js"],
    ],
    function (Axis, D, H, RangeSelectorComposition, SVGElement, U) {
      /* *
       *
       *  (c) 2010-2021 Torstein Honsi
       *
      ...
      function preferredInputType(format) {
        ...
        const time = ["H", "k", "I", "l", "M", "S"].some(
          (char) => format.indexOf("%" + char) !== -1
        );
        if (date && time) {
      ...
      class RangeSelector {
        ...
        static compose(AxisClass, ChartClass) {
          RangeSelectorComposition.compose(
            AxisClass,
            ChartClass,
            RangeSelector
          );
          ...
          if (input && dateBox && this.inputGroup) {
            ...
            if (isTextInput && inputBoxWidth) {
              ...
              css(input, {
                ...
                top:
                  translateY - (input.offsetHeight - dateBox.height) / 2 + "px",
              });
            }
          }
        }
          ...
          if (inputEnabled) {
            ...
            if (
              ...
              this.setInputExtremes(
                ...
                Math.min(unionExtremes.dataMax, this.getInputValue("max")) -
                  minRange
              );
              this.setInputExtremes(
                "max",
                Math.max(unionExtremes.dataMin, this.getInputValue("min")) +
                  minRange,
        ...
        renderButtons() {
          ...
          this.buttonGroup = renderer
            .g("range-selector-buttons")
            .add(this.group);
          const dropdown = (this.dropdown = createElement(
            "select",
            void 0,
            {
              position: "absolute",
        ...
        alignElements() {
          ...
          const getXOffsetForExportButton = (group, position) => {
            if (
              ...
              position.y - group.getBBox().height - 12 <
            ...
            if (verticalAlign === "bottom") {
              ...
              const legendHeight =
                ...
                !legendOptions.floating
                  ? chart.legend.legendHeight + pick(legendOptions.margin, 10)
                  : 0;
          ...
          const groupsOverlap = (buttonGroupWidth) => {
            if (inputGroup && buttonGroup) {
              ...
              return (
                ...
                buttonPosition.y < inputPosition.y + inputGroup.getBBox().height
              );
            }
            return false;
          };
  ...
  _registerModule(
    ...
    [
      _modules["Stock/RangeSelector/RangeSelector.js"],
      _modules["Accessibility/AccessibilityComponent.js"],
      _modules["Accessibility/Utils/ChartUtilities.js"],
      _modules["Accessibility/Utils/Announcer.js"],
      _modules["Accessibility/KeyboardNavigationHandler.js"],
    ...
    function (
       ...
       *
       * */
      const { unhideChartElementFromAT, getAxisRangeDescription } =
        ChartUtilities;
      ...
      function shouldRunInputNavigation(chart) {
        return Boolean(
          chart.rangeSelector &&
            ...
            chart.rangeSelector.inputGroup.element.style.visibility !==
              "hidden" &&
      ...
      class RangeSelectorComponent extends AccessibilityComponent {
        ...
        updateSelectorVisibility() {
          ...
          if (rangeSelector && rangeSelector.hasVisibleDropdown && dropdown) {
            ...
            buttons.forEach((btn) =>
              unhideChartElementFromAT(chart, btn.element)
            );
          }
        }
        /**
        ...
        onButtonNavKbdClick(keyboardNavigationHandler) {
          ...
          if (!wasDisabled) {
            this.fakeClickEvent(
              chart.rangeSelector.buttons[chart.highlightedRangeSelectorItemIx]
                .element
            );
          }
          return response.success;
      ...
      (function (RangeSelectorComponent) {
        ...
        function chartHighlightRangeSelectorButton(ix) {
          ...
          const curSelectedIx =
            this.rangeSelector && this.rangeSelector.selected;
          // Deselect old
          if (
          ...
          while (i--) {
            ...
            if (pointOptions.marker) {
              const isStillForcedMarker =
                hadForcedMarker && getPointMarkerOpacity(pointOptions) === 0;
  ...
  _registerModule(
    ...
    function (
      ...
      const { getPointFromXY, getSeriesFromName, scrollToPoint } =
        ChartUtilities;
      /* *
       *
       *  Functions
      ...
      class SeriesKeyboardNavigation {
        ...
        onKbdVertical(handler, keyCode) {
          const chart = this.chart,
            ...
            navOptions =
              chart.options.accessibility.keyboardNavigation.seriesNavigation;
      ...
      (function (SeriesKeyboardNavigation) {
          ...
          this.series.forEach((series) => {
            ...
            series.points.forEach((point) => {
              ...
              const width = Math.abs(point.plotX - curPoint.plotX),
                distance =
                  Math.abs(yDistance) * Math.abs(yDistance) + width * width * 4; // Weigh horizontal distance highly
        ...
        function getClosestPoint(point, series, xWeight, yWeight) {
          ...
          const hasUndefinedPosition = (point) =>
  ...
  _registerModule(
    ...
    [
      _modules["Accessibility/AccessibilityComponent.js"],
      _modules["Accessibility/Utils/ChartUtilities.js"],
      _modules["Accessibility/Components/SeriesComponent/ForcedMarkers.js"],
      _modules["Accessibility/Components/SeriesComponent/NewDataAnnouncer.js"],
      _modules["Accessibility/Components/SeriesComponent/SeriesDescriber.js"],
      _modules[
        "Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js"
      ],
  ...
  _registerModule(
    ...
    function (AccessibilityComponent, CU, HU, KeyboardNavigationHandler, U) {
      /* *
       *
       *  (c) 2009-2021 Øystein Moseng
       *
      ...
      class ZoomComponent extends AccessibilityComponent {
        ...
        updateProxyOverlays() {
          ...
          if (chart.resetZoomButton) {
            this.createZoomProxyButton(
              ...
              chart.langFormat("accessibility.zoom.resetZoomButton", {
                chart: chart,
              })
            );
          }
          if (
            ...
            this.createZoomProxyButton(
              chart.drillUpButton,
              "drillUpProxyButton",
              chart.langFormat("accessibility.drillUpButton", {
                chart: chart,
        ...
        createZoomProxyButton(buttonEl, buttonProp, label) {
          this[buttonProp] = this.proxyProvider.addProxyElement(
            "zoom",
            {
              click: buttonEl,
            },
        ...
        onMapKbdArrow(keyboardNavigationHandler, keyCode) {
          const chart = this.chart,
            ...
            granularity = 10,
            diff =
              ((isY ? chart.plotHeight : chart.plotWidth) / granularity) *
              stepDirection,
            ...
            endPos = isY
              ? { x: startPos.x, y: startPos.y + diff }
        ...
        onMapKbdTab(keyboardNavigationHandler, event) {
          ...
          const isMoveOutOfRange =
            (isBackwards && !this.focusedMapNavButtonIx) ||
            (!isBackwards && this.focusedMapNavButtonIx);
          // Deselect old
          chart.mapNavigation.navButtons[this.focusedMapNavButtonIx].setState(
            0
          );
          if (isMoveOutOfRange) {
            if (chart.mapView) {
          ...
          const button =
            chart.mapNavigation.navButtons[this.focusedMapNavButtonIx];
    ...
    function (H) {
      ...
      function isHighContrastModeActive() {
        ...
        if (isMS && win.getComputedStyle) {
          ...
          const bi = (testDiv.currentStyle || win.getComputedStyle(testDiv))
            .backgroundImage;
  ...
  _registerModule(
    _modules,
    "Accessibility/HighContrastTheme.js",
    [],
    function () {
      /* *
       *
  ...
  _registerModule(
    _modules,
    "Accessibility/Options/A11yDefaults.js",
    [],
    function () {
      /* *
       *
  ...
  _registerModule(
    _modules,
    "Accessibility/Options/LangDefaults.js",
    [],
    function () {
      /* *
       *
      ...
      const langOptions = {
        ...
        accessibility: {
          ...
          seriesTypeDescriptions: {
            boxplot:
              "Box plot charts are typically used to display " +
              "groups of statistical data. Each data point in the " +
              "chart can have up to 5 values: minimum, lower quartile, " +
              "median, upper quartile, and maximum.",
            arearange:
              "Arearange charts are line charts displaying a " +
              "range between a lower and higher value for each point.",
            areasplinerange:
              "These charts are line charts displaying a " +
              "range between a lower and higher value for each point.",
            bubble:
              "Bubble charts are scatter charts where each data " +
              "point also has a size value.",
            columnrange:
              "Columnrange charts are column charts " +
              "displaying a range between a lower and higher value for " +
              "each point.",
            errorbar:
              "Errorbar series are used to display the " +
              "variability of the data.",
            funnel:
              "Funnel charts are used to display reduction of data " +
              "in stages.",
            pyramid:
              "Pyramid charts consist of a single pyramid with " +
              "item heights corresponding to each point value.",
            waterfall:
              "A waterfall chart is a column chart where each " +
        ...
        chart.series.forEach(function (series) {
          ...
          Object.keys(oldToNewSeriesOptions).forEach(function (oldOption) {
            ...
            if (typeof optionVal !== "undefined") {
              ...
              error(32, false, chart, {
                [`series.${oldOption}`]:
                  "series." + oldToNewSeriesOptions[oldOption].join("."),
              });
            }
          });
        });
  ...
  _registerModule(
    ...
    [
      ...
      _modules["Accessibility/Utils/HTMLUtilities.js"],
      _modules["Accessibility/A11yI18n.js"],
      _modules["Accessibility/Components/ContainerComponent.js"],
      _modules["Accessibility/FocusBorder.js"],
      _modules["Accessibility/Components/InfoRegionsComponent.js"],
      _modules["Accessibility/KeyboardNavigation.js"],
      _modules["Accessibility/Components/LegendComponent.js"],
      _modules["Accessibility/Components/MenuComponent.js"],
      _modules["Accessibility/Components/SeriesComponent/NewDataAnnouncer.js"],
      _modules["Accessibility/ProxyProvider.js"],
      _modules["Accessibility/Components/RangeSelectorComponent.js"],
      _modules["Accessibility/Components/SeriesComponent/SeriesComponent.js"],
      _modules["Accessibility/Components/ZoomComponent.js"],
      _modules["Accessibility/HighContrastMode.js"],
      _modules["Accessibility/HighContrastTheme.js"],
      _modules["Accessibility/Options/A11yDefaults.js"],
      _modules["Accessibility/Options/LangDefaults.js"],
      _modules["Accessibility/Options/DeprecatedOptions.js"],
    ],
    function (
      D,
      H,
  ...
  _registerModule(
    ...
    [
      _modules["Core/Globals.js"],
      _modules["Accessibility/Accessibility.js"],
      _modules["Accessibility/AccessibilityComponent.js"],
      _modules["Accessibility/Utils/ChartUtilities.js"],
      _modules["Accessibility/Utils/HTMLUtilities.js"],
      _modules["Accessibility/KeyboardNavigationHandler.js"],
