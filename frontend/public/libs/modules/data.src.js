...
(function (factory) {
  ...
  _registerModule(
    ...
    function (Chart, D, G, HU, Point, SeriesRegistry, U) {
      /* *
       *
       *  Data module
       *
      ...
      class Data {
        ...
        init(dataOptions, chartOptions, chart) {
          let decimalPoint = dataOptions.decimalPoint,
            hasData;
          if (chartOptions) {
            this.chartOptions = chartOptions;
          }
          ...
          this.options = dataOptions;
          this.columns =
            dataOptions.columns || this.rowsToColumns(dataOptions.rows) || [];
        ...
        getColumnDistribution() {
          ...
          seriesMapping.forEach((mapping) => {
            const builder = new SeriesBuilder(),
              numberOfValueColumnsNeeded =
                individualCounts[seriesIndex] || getValueCount(globalType),
        ...
        parseCSV(inOptions) {
          const self = this,
            ...
            startColumn =
              typeof options.startColumn !== "undefined" && options.startColumn
                ? options.startColumn
                : 0,
        ...
        parseGoogleSpreadsheet() {
          ...
          const getRange = () => {
            ...
            const start =
              (alphabet.charAt(options.startColumn || 0) || "A") +
          ...
          if (googleSpreadsheetKey) {
            ...
            fetchSheet(function (json) {
              ...
              const rowCount = columns.reduce(
                (rowCount, column) => Math.max(rowCount, column.length),
                0
              );
        ...
        update(options, redraw) {
          ...
          if (options) {
            ...
            if (
              chartOptions.data &&
              chartOptions.data.googleSpreadsheetKey &&
              !options.columns
            ) {
  ...
  _registerModule(
    ...
    [
      _modules["Core/Globals.js"],
      _modules["Core/HttpUtilities.js"],
      _modules["Extensions/Data.js"],
    ],
    function (Highcharts, HttpUtilities, Data) {
      const G = Highcharts;
      // Functions
